(function() {
    ...
    const t = Function("return this")(), e = t, n = t, r = t, {WeakSet: o, WeakMap: i, Date: s, RegExp: c, Event: u, CustomEvent: a, requestAnimationFrame: f, URL: l, Blob: h, Element: d, Node: p, String: v, Array: w, document: m, Object: y, Reflect: g, Proxy: b, Symbol: E, Boolean: O, Promise: P, Set: S, Math: x, Error: C, TypeError: L, JSON: T, Map: j, clearTimeout: k, setTimeout: N, parseInt: M, Number: R} = t;
    class A {
        constructor() {
    ...
    var _ = function(t) {
        ...
        return K.Date.now();
    }, F = K.Symbol, z = y.prototype, B = z.hasOwnProperty, U = z.toString, q = F ? F.toStringTag : void 0;
    var I = function(t) {
        var e = B.call(t, q), n = t[q];
        try {
            t[q] = void 0;
            var r = !0;
        } catch (t) {}
    ...
    const {apply: Ot, construct: Pt, defineProperty: St, deleteProperty: xt, getOwnPropertyDescriptor: Ct, getPrototypeOf: Lt, has: Tt, ownKeys: jt, preventExtensions: kt} = g;
    function Nt(t, e) {
    ...
    let Rt = [];
    let At = !1, _t = new S, Dt = new S, $t = new S;
    function Wt(t) {
        if (!vt(t)) throw L();
        if (!At) throw C();
        _t.add(t);
    ...
    function Ft() {
        _t = new S, Dt = new S, $t = new S, Rt = [];
    }
    var zt, Bt, Ut;
    const qt = E("addonelistner"), It = E("removeonelistner"), Vt = E("cancelsubscribe"), Zt = E("debouncedispatch");
    function Jt(t) {
    ...
    class ne {
        constructor(t) {
            var e;
            this[E.toStringTag] = "ReactiveState", this[zt] = (() => {
                const t = ct(() => {
                    this[Gt].dispatch();
                });
                return () => {
            ...
            })(), this[Bt] = new A, this[Ut] = new S, this.valueOf = () => this.value, this.value = t, 
            St(this, "value", {
                value: t,
                configurable: !0,
                writable: !0
    ...
    const ge = /\B([A-Z])/g, be = t => t.replace(ge, "-$1").toLowerCase(), Ee = n.String, Oe = n.Reflect, {get: Pe, set: Se, ownKeys: xe} = Oe;
    function Ce(t) {
        return "object" == typeof t && null !== t;
    }
    function Le(t) {
    ...
    const je = t => "input" === ke(t) && ("checkbox" === Pe(t, "type") || "radio" === Pe(t, "type"));
    function ke(t) {
    ...
    function Re(t) {
        ...
        const n = new b(e, {
            ownKeys() {
                const e = function(t) {
                    const e = ke(t);
                    return "textarea" === e || "select" === e || "input" === e && "text" === Pe(t, "type");
                }(t), n = function(t) {
                    return t.getAttributeNames();
                }(t);
                return w.from(new S([ ...n, je(t) ? "checked" : void 0, e ? "value" : void 0 ].flat(1 / 0).filter(t => !!t)));
            },
            get(e, n) {
                if (ye(ke(t), Ee(n), Pe(t, "type"))) return Pe(t, Ee(n));
                {
    ...
    const ze = w(26).fill(void 0).map((t, e) => 97 + e).map(t => v.fromCharCode(t)), Be = w(16).fill(void 0).map((t, e) => e).map(t => t.toString(16)), Ue = [ ...new S([ ...Be, ...ze ]) ];
    function qe(t = 1) {
        return w(t).fill(void 0).map(() => Nt(ze, x.floor(x.random() * ze.length))).join("") + "-" + w(t).fill(void 0).map(() => Nt(Ue, x.floor(x.random() * Ue.length))).join("");
    }
    ...
    Tt(Je, Ie) || g.set(Je, Ie, new S), Tt(Je, Ve) || g.set(Je, Ve, {});
    function Ge(t, e, n = 1) {
        if (!He(t)) throw L();
    ...
    function Qe(t, e, n) {
        let r = t;
        if (vt(r) && (r = Hn(r)), He(t = r)) return ((t, e) => {
            Ge(t, e);
        })(t), Pt(t, [ e, n ]);
        throw L();
    }
    ...
    function rn(t, e) {
        e.element.push(t), ((t, e) => {
            ...
            Tt(t, on) || Mt(t, on, new S), Nt(t, on).add(e);
        });
    }
    new MutationObserver((function(t, e) {
        t.forEach((function(t) {
            [ ...t.addedNodes ].forEach(t => {
                t.dispatchEvent(new u("connected"));
            }), [ ...t.removedNodes ].forEach(t => {
                t.dispatchEvent(new u("disconnected"));
            });
        }));
    })).observe(m.body, {
        childList: !0,
    ...
    const on = E("bindstate");
    function sn(t) {
        throw L();
    }
    function cn(t, e) {
        if (wt(t)) return t.map(t => cn(t)).flat(1 / 0);
        if (lt(t) || pt(t)) {
            return ue(t);
        }
        if (Jt(t)) {
            ...
            const r = n;
            return Mt(r, on, new S), Nt(r, on).add(e), n;
        }
        if ($e(t)) {
            let {type: n} = t;
            vt(n) && (n = Hn(n));
            ...
            }(n) || r && Fe(t.children.map(t => "svg" === n && $e(t) ? cn(t, ae) : "math" === n && $e(t) ? cn(t, "http://www.w3.org/1998/Math/MathML") : e && $e(t) ? cn(t, e) : cn(t)), r)), 
            r && rn(r, t), r;
        }
        sn();
    }
    ...
    function an(t, e) {
        ...
        const r = pe(t);
        if (Ke(t)) Fe(cn(r), e); else {
            if (!(un(t) || (o = t, wt(o) && o.length && o.every(t => un(t))))) throw L();
            Fe(r, e);
        }
        var o;
        return e;
    ...
    function pn(t, e, n) {
        ...
        Nt(ln, r) || Mt(ln, t, new S), e ? Nt(ln, r).add(function(t) {
            const e = dn.get(t);
            if (e) return e;
            {
    ...
    function vn(t, e) {
        return t.map(t => {
            ...
            return function(t) {
                ...
                const n = vn([ ...t.cssRules ], e), r = t.conditionText;
                return {
                    cssText: t.cssText.slice(0, 7) + r + "{" + hn(n) + "}",
                    conditionText: r,
                    cssRules: n,
    ...
    function yn(t, e) {
        pn(e, function(t, e) {
            ...
            if (n) return n;
            {
                const n = hn(vn(wn(t), e).filter(O));
                return mn.set(t, n), n;
            }
        }(t, e));
    }
    function gn(t, e) {
        return P.all([ ...Nt(ln, t) ].map(t => {
            return de(`link[rel="stylesheet"][href="${t}"]`).length ? P.resolve() : (n = cn(Fn("link", {
                href: t,
                rel: "stylesheet"
            })), r = e, new P(t => {
                const e = () => {
    ...
    function En(t) {
        if (wt(t)) t.forEach(t => {
            ...
            }(t), Tt(t, on) && Nt(t, on).forEach(t => {
                Xn(t), t[Xt]();
            }), Tt(t, Mn) && Nt(t, Mn).forEach(t => {
                Xn(t);
            }), Tt(t, Nn)) {
                Nt(t, Nn).forEach(([t, e]) => {
                    e && t[qt](e);
    ...
    var Sn;
    const xn = E("attributeChanged"), Cn = E("firstinstalled");
    function Ln(t) {
        jn.prototype.connectedCallback.call(t);
    }
    function Tn(t) {
        jn.prototype.disconnectedCallback.call(t);
    }
    ...
    Sn = Pn;
    const kn = E("waittranformcss"), Nn = E("innerwatchrecord"), Mn = E("innerstate"), Rn = E("attributes"), An = E("innerelement"), _n = E("innervdom"), Dn = E("mounted"), $n = E("unmounted");
    function Wn(t) {
        var e, n, r;
        if (vt(t)) {
            const o = ve.get(t);
            ...
            class c extends jn {
                constructor(n = {}, o = []) {
                    ...
                    if (i) {
                        ...
                        Nt(ln, t) || (Mt(ln, t, new S), this[kn] = () => bn(() => {
                            yn(i, t);
                        }));
                    }
                    const s = Re(this);
                    ...
                    this[Rn] = u;
                    const a = fn(y.fromEntries(y.entries(u).map(([t, e]) => [ t, fn(e) ])));
                    let f;
                    try {
                        f = Ot(t, void 0, [ a, o.flat(1 / 0) ]);
                    } catch (t) {
                        throw Ht(), t;
                    }
                    ...
                    {
                        const t = pe(f);
                        this[_n] = t.flat(1 / 0).filter(O), this[Dn] = [ ..._t ], this[$n] = [ ...Dt ], 
                        this[Mn] = [ ...$t ], this[Nn] = [ ...Rt ], Ht();
                    }
                }
                [(e = Rn, n = Xe, r = Pn, Cn)]() {
                    const t = () => (re(this, ""), gn(r, m.head)), e = () => {
                        Fe(this[An], this, !1), this[kn] = void 0;
                    };
                    if (!this[An]) {
                        const t = this[_n];
                        t && (this[An] = cn(t).flat(1 / 0), this[_n] = []);
                    }
                    const n = Nt(this.constructor, "css"), r = this.tagName.toLowerCase();
                    if (n) {
                        const n = this[kn];
                        n ? n().then(t).then(e) : P.resolve(t).then(e);
                    } else Fe(this[An], this);
                }
                connectedCallback() {
                    bn(() => {
                        Ln(this), this[Dn].forEach(t => {
                            bn(t);
                        });
                    });
                }
    ...
    function Fn(t, e, ...n) {
        return vt(t) && (t = Hn(t)), wt(e) ? Ot(zn, void 0, [ t, void 0, [ ...e, ...n ].flat(1 / 0) ]) : Ot(zn, void 0, [ t, e, ...n ]);
    }
    function zn(t, e = {}, ...n) {
        let r = pt(t) || vt(t) ? t : "";
        const o = at(e) ? e : {}, i = n.flat(1 / 0).map(t => 0 === t ? "0" : t).filter(t => !!t);
        return pt(r) && (r = r.trim().toLowerCase()), "" === r ? i : Ot(We, void 0, [ r, o, i ]);
    }
    const Bn = E("truevdom"), Un = E("falsevdom"), qn = E("trueele"), In = E("falseele"), Vn = E("handletrue"), Zn = E("handlefalse"), Jn = E("currentelement"), Gn = function(t, e, n) {
        var r, o, i, s, c;
        ...
        class f extends jn {
            ...
            [(r = Jn, o = Xe, i = Pn, s = Bn, c = Un, Zn)]() {
                this[In] || (this[In] = cn(this[Un]), this[Un] = []);
                const t = this[In][0] || this;
                fe(t, this[Jn]), this[Jn] = t;
            }
            [Vn]() {
                this[qn] || (this[qn] = cn(this[Bn]), this[Bn] = []);
                const t = this[qn][0] || this;
                fe(t, this[Jn]), this[Jn] = t;
            }
            [Cn]() {
                const e = t => {
                    !0 === t ? Nt(this, Vn).call(this) : t || Nt(this, Zn).call(this);
                };
                Jt(t) ? (e(t.valueOf()), Qn(t, t => {
                    e(t);
                })) : e(t);
            }
            connectedCallback() {
    ...
    function er(t, e, n, r, o, i) {
        ...
        Mt(i.bindattr, e, o), r.forEach(t => {
            ...
            Mt(i.onevent, t, pe([ ...e, t => o.value = Nt(t.target, n) ]).filter(O));
        });
    }
    tr("ref", (t, e, n) => {
        if (vt(t)) Ot(t, void 0, [ e ]); else {
            if (!dt(t)) throw L();
            Mt(t, "value", e);
        }
    }), tr("html", (t, e, n) => {
        ...
        if (!Jt(t)) throw new L;
        er([ "input", "textarea", "select" ], "value", "value", [ "change", "input" ], t, n);
    }), tr("checked", (t, e, n) => {
        if (!Jt(t)) throw new L;
        er([ "input" ], "checked", "checked", [ "change" ], t, n);
    ...
    const {HTMLElement: nr, customElements: rr, Proxy: or} = n;
    if (!vt(nr) || !vt(or) || !dt(rr)) throw new L;
    const ir = E("cancel_watch"), sr = E("cached_class_element"), cr = E("switch_mount");
    function ur(t) {
        var e, n, r;
        if (!Jt(t)) throw new L;
        class o extends jn {
    ...
    const fr = function(t, e, n) {
        if (!wt(t) && !Jt(t) || !vt(e)) throw L();
        const r = pe(t);
        if (!r.length) throw new C;
        return function(t, e, n) {
            const r = new ne, o = () => {
                const n = Ot(e, void 0, t.map(t => t.valueOf())), r = Jt(n) ? n.valueOf() : n;
    ...
    const hr = S.prototype, dr = j.prototype;
    function pr(t) {
        return t instanceof j;
    }
    function vr(t) {
    ...
    const mr = n.Reflect, {ownKeys: yr, deleteProperty: gr, apply: br, construct: Er, defineProperty: Or, get: Pr, getOwnPropertyDescriptor: Sr, getPrototypeOf: xr, has: Cr, set: Lr, setPrototypeOf: Tr} = mr;
    function jr(t) {
        return "object" == typeof t && null !== t;
    }
    function kr(t) {
    ...
    function Nr(t, e) {
        if (!kr(e)) throw C();
        if (!kr(b)) throw C();
        return kr(t) || jr(t) ? function t(e, n, r = [], o = e) {
            if (!kr(n)) throw C();
            if (e instanceof P || function(t) {
            ...
            if (kr(e) || jr(e)) {
                let i;
                return vr(e) ? (i = new S([ ...e ]), Lr(i, "add", t => (hr.add.call(e, t), n(o, r, void 0, void 0), 
                hr.add.call(i, t))), Lr(i, "delete", t => (hr.delete.call(e, t), n(o, r, void 0, void 0), 
                hr.delete.call(i, t))), Lr(i, "clear", () => (hr.clear.call(e), n(o, r, void 0, void 0), 
                hr.clear.call(i)))) : pr(e) ? (i = new j([ ...e ]), Lr(i, "clear", () => (dr.clear.call(e), 
                n(o, r, void 0, void 0), dr.clear.call(i))), Lr(i, "set", (t, s) => (dr.set.call(e, t, s), 
                n(o, r, void 0, void 0), dr.set.call(i, t, s))), Lr(i, "delete", t => (dr.delete.call(e, t), 
                n(o, r, void 0, void 0), dr.delete.call(i, t)))) : i = wr(e) ? [] : kr(e) ? () => {} : {}, 
                vr(e) || pr(e) || Tr(i, null), new b(i, {
                    defineProperty: (t, i, s) => (n(o, [ ...r, v(i) ], Cr(s, "value") ? s.value : kr(s.get) ? s.get() : void 0, Pr(e, i)), 
                    Or(e, i, s)),
                    deleteProperty: (t, i) => (n(o, [ ...r, v(i) ], void 0, Pr(e, i)), gr(e, i)),
                    ownKeys: () => yr(e),
                    has: (t, n) => Cr(e, n),
                    getPrototypeOf: () => xr(e),
                    setPrototypeOf: (t, n) => Tr(e, n),
                    construct(t, n) {
                        if (kr(e)) return Er(e, n);
                    },
                    apply(t, n, r) {
                        if (kr(e)) return br(e, n, r);
                    },
                    getOwnPropertyDescriptor(t, n) {
                        var r = Sr(e, n);
                        return wr(e) && "length" === n ? r : r ? (r.configurable = !0, r) : void 0;
                    },
                    set: (t, i, s) => (kr(n) && n(o, [ ...r, v(i) ], s, Pr(e, i)), Lr(e, i, s)),
                    get(o, s) {
                        var c = Pr(e, s);
                        return kr(c) && (vr(e) || pr(e)) ? Pr(i, s).bind(i) : kr(c) || jr(c) ? t(c, n, [ ...r, v(s) ], e) : c;
                    }
                });
            }
            return e;
    ...
    const Mr = S.prototype;
    function Rr(t) {
        if (Et(t) || vt(t)) return ar(new b(new ne(t), {
            defineProperty: () => !1,
            deleteProperty: () => !1,
            set(e, n, r) {
        ...
        if (dt(t)) return function(t) {
            ...
            const i = {
                ownKeys: t => w.from(new S([ ...jt(t), ...jt(Nt(t, "value")) ])),
                setPrototypeOf: () => !1,
                defineProperty: () => !1,
                getOwnPropertyDescriptor: (t, e) => {
                    if (ut(e)) return;
                ...
                get: (t, e) => {
                    ...
                    if ("value" === e && r) return Nr(Nt(t, e), (e, n) => {
                        t[Xt]();
                    });
                    if (Tt(t, e)) return Nt(t, e);
                    if (Tt(n, e)) {
                        const o = Nt(n, e);
                        if (!yt(n)) return r && (wt(o) || at(o)) ? Nr(o, () => {
                            t[Xt]();
                        }) : o;
    ...
    const mycomapp = Kn(() => {
        ...
        const plus = fr(x, x => x + 100);
        const multi = fr([ x, y ], (x, y) => x * y);
        let count = 0;
        const cancelwatch = Qn([ x, y, multi, plus ], (...args) => {
            if (count === 0) {
        ...
        return Fn("div", null, Fn("h3", null, " \u9f20\u6807\u4f4d\u7f6e"), Fn("h2", null, "x:", x), Fn("h1", null, "y:", y), Fn("p", null, "x+100 \u662f", plus), Fn("p", null, "x*y \u662f", multi));
    });
    mycomapp.css = `\n*{font-size:80px !important;}\np{color:blue !important;}\n`;
    var vdom = Fn(mycomapp);
    document.body.appendChild(an(vdom, document.createElement("div")));
    const refarray = [];
    const liststate = Rr(Array(10).fill(undefined).map((v, i) => i));
    Qn(liststate, a => console.dir([ liststate, a ]));
    const testlistvdom = Fn("div", null, Fn("button", {
        $text: "push",
        onclick: () => {
    ...
    const weathercondition = Rr(true);
    const vdom$1 = [ Gn(weathercondition, testlistvdom), Fn("", null, Fn("button", {
        onclick: () => {
    ...
    console.log([ Fn, Fn ]);
    const mycomapp$1 = Kn(() => {
        const inputpassword = Rr("");
        const inputref = lr();
        const inputref2 = lr();
        console.log(inputref2);
        console.log(inputpassword);
        Qn(inputpassword, console.log);
        const vdom = [ Fn("h1", {
            ...
            style: "\n      width: 100%;\n      height: 200px;\n  "
        }, Fn("title", null, "logo-on-dark-bg"), Fn("rect", {
            Color: "#FFF",
            x: "0",
            y: "0",
            width: "3046.7",
        ...
        }))), Fn("div", null, Fn("div", null, Fn("noscript", null, "You need to enable JavaScript to run this app."), Fn("div", {
            id: "root"
        }, Fn("div", null, Fn("div", {
            ...
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/picalc"
        }, "\u5706\u5468\u7387\u8ba1\u7b97\u591a\u7ebf\u7a0b")), Fn("li", null, Fn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/react-huami"
        }, "\u82b1\u5bc6\u7f51\u9875\u7248")), Fn("li", null, Fn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/decoder"
        }, "JSfuck-and-hieroglyphy-Decoder")), Fn("li", null, Fn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/jsfuck"
        }, "JSfuck-ENCODER")), Fn("li", null, Fn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/hieroglyphy"
        }, "hieroglyphy-ENCODER")), Fn("li", null, Fn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
        ...
        }, "\u52a8\u6001\u5f02\u6b65\u52a0\u8f7d-commonjs\u548cumd\u548camd\u6a21\u5757\u5e93")), Fn("li", {
            class: "nav-item"
        }, Fn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/react-simple-global-state-store-hook"
        }, "\u9002\u7528\u4e8eReact\u7684\u6781\u7b80\u5168\u5c40\u72b6\u6001\u7ba1\u7406\u5e93")), Fn("li", {
            class: "nav-item"
        }, Fn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
        ...
        }, "\u9002\u7528\u4e8eVue\u7684\u6781\u7b80\u5168\u5c40\u72b6\u6001\u7ba1\u7406\u5e93")), Fn("li", null, Fn("a", {
            href: "./my-vue-router-project/index.html",
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined"
        }, "\u57fa\u4e8evue\u7684\u4e3b\u9875")), Fn("li", null, Fn("a", {
        ...
        }, Fn("h1", null, "\u82b1\u5bc6 \u4e0d\u4e00\u6837\u7684\u5bc6\u7801\u7ba1\u7406\u5de5\u5177"), Fn("div", {
            id: "rong1",
            class: "container",
            style: "text-align: center;"
        }, Fn("div", {
            id: "rong2"
        }, Fn("h2", null, Fn("span", null, "1"), "\u8f93\u5165"), Fn("div", {
            id: "input"
        }, Fn("p", null), Fn("h3", null, "\u8bb0\u5fc6\u5bc6\u7801"), Fn("p", null), Fn("p", null, Fn("input", {
            "*ref": inputref,
            ...
            value: ""
        })), Fn("p", null), Fn("span", null, "+"), Fn("h3", null, "\u533a\u5206\u4ee3\u53f7"), Fn("p", null), Fn("p", null, Fn("input", {
            "*ref": inputref2,
            "*value": inputpassword,
            "@input": e => console.log(e),
            id: "key",
            ...
            class: "col-lg-12 col-md-12 col-sm-12 col-xs-12 form-control",
            value: ""
        }))), Fn("br", null), Fn("p", null), Fn("h2", null, Fn("span", null, "2"), "\u83b7\u53d6"), Fn("p", null), Fn("div", {
            id: "get"
        }, Fn("p", {
            id: "tuijian"
        }), Fn("p", null), Fn("h3", null, "\u6700\u7ec8\u5bc6\u7801"), Fn("p", null), Fn("span", {
            id: "myhezi"
        }, Fn("p", null, Fn("input", {
            ...
            value: ""
        })), Fn("br", null), Fn("p", null, Fn("button", {
            id: "copycode16",
            "data-clipboard-target": "#code16",
            class: "btn btn-lg btn copycode16d btn-info",
            style: "width: 100%;"
        }, "\u70b9\u51fb\u590d\u5236"))), Fn("p", null, Fn("span", {
            id: "copyOK",
            style: "display: none;"
        }, "\u221a\u590d\u5236\u6210\u529f")), Fn("p", null)))))))), Fn("script", {
    ...
    mycomapp$1.css = css;
    var vdom$2 = Fn(mycomapp$1);
    an(vdom$2, document.getElementById("root"));
    console.log([ Fn, Fn ]);
    const vdom$3 = Fn("select", {
        ...
        value: "0"
    }, "- Select version -"), Fn("option", {
        value: "94b92331-e2f4-40c6-90ee-80e203a4de3a"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [arm64]"), Fn("option", {
        value: "7268dbc9-dfe0-4947-af82-67f384e95cb6"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x64]"), Fn("option", {
        value: "08f0d32e-c68a-46a8-b301-57e86b4e96e0"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x86]"), Fn("option", {
        value: "9fa87c7f-75fa-4e5e-9ca3-1e19cb2c743f"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x64]"), Fn("option", {
        value: "5173796c-11ac-47d7-9ed7-dbad6d5c9486"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x86]"), Fn("option", {
        value: "4adf5f24-213a-472c-ae94-70f3cb81bade"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [arm64]"), Fn("option", {
        value: "9287fe5e-2cb3-4064-820f-3e336a3ddff4"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [arm64]"), Fn("option", {
        value: "5e420f0d-b3a5-424c-9b55-5c2cf939af14"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [x86]"), Fn("option", {
    ...
    const mycomappclass = Kn(() => {
        Qn(store.number, number => {
            console.log({
                ...store
            }, number);
        });
        const vdom = Fn("div", null, Fn("h3", null, " \u70b9\u51fb\u6570\u5b57"), Fn("h2", null, "number:", store.number), Fn("button", {
    ...
    let vdom$4 = [ Fn(mycomappclass), Fn(mycomappclass), Fn(mycomappclass) ];
    ...
    const lirefs = [];
    const temp$ref = lr();
    const check = Rr(false);
    const check2 = Rr(true);
    Qn(check2, a => console.log(a));
    const check3 = Rr(true);
    Qn(check3, a => console.log(a));
    const check4 = Rr(true);
    Qn(check4, a => console.log(a));
    const notcheck = fr(check, a => !a, v => {
        console.log(notcheck, check, v);
        check.value = !v;
    });
    var list = Array(10).fill(undefined).map((v, i) => i);
    Qn(check, a => console.log(a));
    Qn(notcheck, a => console.log(a));
    var vdom$5 = Fn("", null, Fn("input", {
        type: "radio",
        $checked: check4,
        name: "myname1"
    }), Fn("input", {
        ...
        type: "checkbox",
        $checked: notcheck
    }), Fn("", null, Fn("ul", null, list.map((a, index) => Fn("li", {
        $ref: ele => {
            lirefs[index] = ele;
        ...
        class: "title"
    }, "\u4f60\u7684\u4ed3\u5e93 masx200/mvvm-reactive-view \u5df2\u7ecf\u4ece https://github.com/masx200/mvvm-reactive-view.git \u540c\u6b65\u6210\u529f"), Fn("div", {
        class: "meta"
    }, Fn("time", {
        class: "timeago"
    }, "2\u5c0f\u65f6\u524d"), " ", "\xb7", " ", Fn("span", {
        class: "namespace"
    }, "masx200/mvvm-reactive-view")))), Fn("div", {
    ...
    (() => {
        ...
        var vdom = Gn(mystate, "testtrue", Fn("div", undefined, "testfalese"));
        var vdom2 = Gn(mystate, undefined, Fn("div", undefined, "testwwwwwwwwwfalese"));
        var vdom3 = Gn(mystate, Fn("div", undefined, "testwwwwwwwtrueeeeeeeeee"), undefined);
    ...
    (() => {
        ...
        const inputref = lr();
        const state1 = Rr("hello");
        const vdom = [ Fn("div", {
            style: {
                display: "block",
                width: "100%"
            }
        }, "hello world!"), Fn("input", {
            style: "width:100%",
        ...
        Qn(stylestate, console.log);
        Qn(state1, console.log);
        console.log(vdom);
    ...
    (() => {
        ...
        const state1 = Rr("<a>\u7ed1\u5b9atextcontent</a>");
        const state2 = Rr("<a>\u7ed1\u5b9ainnerhtml</a>");
        const vdom3 = [ Fn("textarea", {
            value: state1,
            "@input": [ e => {
        ...
        const state3 = Rr("<a>\u7ed1\u5b9ainnerhtml</a>");
        const vdom4 = Fn("", null, Fn("div", {
            $text: state3
        }), Fn("div", {
            $html: state3
        }), Fn("script", null, " "));
        Qn(state1, state => state3.value = state);
        Qn(state2, state => state1.value = state);
        console.log(state3);
        console.log(vdom4);
        ...
        const objstate2 = Rr(`{ a: "w", 6: "xxxxxxx", tttttttt: "true" }`);
        console.log(objstate);
        setTimeout(() => {
            objstate.length = 10;
            objstate2.value = 2222222222222;
        }, 2e3);
        const objstatearray = Rr([ {
            a: "w",
            6: "xxxxxxx",
            tttttttt: "true"
        }, 1, true, "test" ]);
        ...
        const classsetstate = Rr(new Set([ "xxxxxxx", "wwwwwww", "eeeeeeee" ]));
        console.log("classsetstate", classsetstate);
        Qn(classsetstate, a => console.log(a));
        setTimeout(() => {
    ...
    (() => {
        var vdom = Fn("math", null, Fn("mrow", null, Fn("mrow", null, Fn("msup", null, Fn("mi", null, "a"), Fn("mn", null, "2")), Fn("mo", null, "+"), Fn("msup", null, Fn("mi", null, "b"), Fn("mn", null, "2"))), Fn("mo", null, "="), Fn("msup", null, Fn("mi", null, "c"), Fn("mn", null, "2"))));
        document.body.appendChild(an(vdom, document.createElement("div")));
        console.log(vdom);
    })();
    ...
    document.body.appendChild(an([ Fn(Bqqqqqqqqq), Fn(Aqqqqqqqqq) ], document.createElement("div")));
    ...
    (() => {
        (() => {
            var _class, _temp;
            var myvdom1111111 = Fn(class extends HTMLElement {
            ...
            document.body.appendChild(an(Fn((() => {
            ...
            const myele1 = Fn((_temp = _class = class extends HTMLElement {}, _defineProperty(_class, "defaultProps", {
    ...
    {
        const vdom = Fn("div", [ [ Fn("html", null, "testhtml"), Fn("button", {
            onclick: [ console.log, () => {
                console.log("onclick");
            } ],
            "*text": "clicktest",
    ...
    (async () => {
        ...
        const Hellowordclass = Object.assign(() => Fn("div", [ "hello world" ], "\u6d4b\u8bd5\u4e0d\u4f7f\u7528createComponent"), {
            css: css,
            defaultProps: defaultProps
        });
        const vdom = Fn(Hellowordclass, null);
        let vdom1 = Fn(Hellowordclass);
        document.body.appendChild(an([ vdom, vdom1 ], document.createElement("div")));
        console.log([ "\u6d4b\u8bd5\u4e0d\u4f7f\u7528createComponent", Hellowordclass, vdom ]);
    })();
    (() => {
        const colortext = Rr("red");
        const stylestate = Rr({
            display: "block",
            width: "100%",
            color: colortext
        });
        const vdom = [ Fn("hr", null), Fn("h1", {
            style: stylestate
        }, "input color ", colortext), Fn("input", {
            $value: colortext
        }), Fn("hr", null) ];
        console.log([ vdom, colortext, stylestate ]);
        Qn([ colortext, stylestate ], (a, b) => console.log([ a, {
            ...b
        } ]));
        document.body.appendChild(an(vdom, document.createElement("div")));
    })();
    (() => {
        const colortext = Rr("blue");
        const stylestate = Rr({
            display: "block",
            width: "100%",
            color: colortext
    ...
    console.log([ Fn, Fn ]);
    (() => {
        var mycom = Kn(Object.assign((props, children) => {
            const number = Rr(1);
            Wt(() => {
            ...
            }, [ number, Fn("br", null), "wwwwwwwwwwww", Fn("div", [ "createComponent" ]), children, Fn("div", Fn("", null, "props cccccc ", props.cccccc)) ]);
        }, {
            defaultProps: {
                cccccc: "bbbbbbb"
            },
        ...
        document.body.appendChild(an(Fn(myclasscomponent, [ Fn("form", {
            id: "newsletterForm",
    ...
    const com1 = Kn(() => Fn("h1", null, "component 1"));
    const com2 = Kn(() => Fn("h1", null, "component 2"));
    const com3 = Kn(() => Fn("h1", null, "component 3"));
    const com4 = () => Fn("h1", null, "component 4");
    const mystate = Rr(com1);
    const vdom$6 = ur(mystate);
    const element$1 = cn(vdom$6);
    ...
    document.body.appendChild(cn(Fn(() => Fn("div", null, Fn("button", {
        $text: "component 1",
        onclick: () => {
            mystate.value = com1;
        }
