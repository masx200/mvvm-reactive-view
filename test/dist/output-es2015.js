(function() {
    ...
    class Ve {
        constructor(t) {
            if (this[p.toStringTag] = "ReactiveState", this[Ne] = new P, this[De] = new y, this.valueOf = () => this.value, 
            !R(t) && !K(t)) throw E();
            this.value = t, h.defineProperty(this, "value", {
                value: t,
                configurable: !0,
                writable: !0
            });
    ...
    function rr(t) {
        var e = function t(e) {
            if (!(R(e) || K(e) || We(e))) throw E();
            if (R(e)) return Nn(new v(new Ve(e), {
                defineProperty: () => !1,
                deleteProperty: () => !1,
                set: (t, e, n) => !("value" !== e || !R(n)) && (t[e] !== n && (rt(t, e, n), t[Be]()), 
                !0),
                setPrototypeOf: () => !1
            }));
            ...
            if (K(e)) return function(t) {
                ...
                var o = {
                    ...
                    set: (t, e, n) => {
                        We(n) && (n = n.valueOf());
                        var r = X(t, "value");
                        return "value" === e && K(n) ? (rt(t, e, n), t[Be]()) : et(t, e) || (rt(r, e, n), 
                        t[Be](a(e))), !0;
                    }
                };
                return new v(i, o);
