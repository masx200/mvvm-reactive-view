(function() {
    ...
    var me = (t, e, n) => "value" === e && we.includes(t) && "button" !== n || "selected" === e && "option" === t || "checked" === e && "input" === t || "muted" === e && "video" === t;
    const ye = /\B([A-Z])/g, ge = i.String, be = i.Reflect, {get: Ee, set: Oe, ownKeys: Pe} = be;
    function Se(t) {
        return "object" == typeof t && null !== t;
    }
    function xe(t) {
    ...
    const je = t => "input" === ke(t) && ("checkbox" === Ee(t, "type") || "radio" === Ee(t, "type"));
    function Te(t) {
        !function(t) {
        ...
        const n = new P(e, {
            ownKeys() {
                const e = function(t) {
                    const e = ke(t);
                    return "textarea" === e || "select" === e || "input" === e && "text" === Ee(t, "type");
                }(t), n = function(t) {
                    return t.getAttributeNames();
                }(t);
                return g.from(new j([ ...n, je(t) ? "checked" : void 0, e ? "value" : void 0 ].flat(1 / 0).filter(t => !!t)));
            },
            get(e, n) {
            ...
            set(e, n, r) {
                ...
                if ("style" === n) {
                    const e = xe(r) ? r : Se(r) ? (i = r, i = N.parse(N.stringify(i)), E.entries(i).map(([t, e]) => {
                        return [ (n = t, n.replace(ye, "-$1").toLowerCase()).trim(), e ];
                        var n;
                    }).map(([t, e]) => t + ":" + e).join(";")) : ge(r);
                    return Oe(Ee(t, "style"), "cssText", e.trim()), !0;
                }
                if ("class" === n && Se(r)) {
                    const e = (o = r, g.isArray(o) ? r.join(" ") : Ce(r) ? [ ...r ].join(" ") : ge(r));
                    return Le(t, ge(n), e), !0;
                }
                return !1 === r || null == r ? (Ne(t, ge(n)), !0) : Ce(r) ? (Le(t, ge(n), N.stringify([ ...r ])), 
                !0) : (!0 === r && (r = ""), Le(t, ge(n), Se(r) ? N.stringify(r) : ge(r)), !0);
                var o, i;
            },
            ...
            getOwnPropertyDescriptor(t, e) {
                ...
                return void 0 !== o ? function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        ...
                        e % 2 ? ve(E(n), !0).forEach((function(e) {
                            pe(t, e, n[e]);
                        })) : E.getOwnPropertyDescriptors ? E.defineProperties(t, E.getOwnPropertyDescriptors(n)) : ve(E(n)).forEach((function(e) {
    ...
    const Me = new c, Re = /[A-Za-z\u4e00-\u9fa5]/;
    function _e(t) {
        return Me.has(t);
    }
    function Ae(t, e = {}, n = []) {
        e = E.assign({}, e), n = n.flat(1 / 0);
        const r = E.entries(e), o = r.filter(([t]) => !(t.startsWith("@") || t.startsWith("on"))), i = o.filter(([t]) => Re.test(t[0])), s = E.create(null), c = s;
        return [ "onevent", "element", "type", "props", "children", "directives", "bindattr" ].forEach(t => {
            ...
            children: n,
            onevent: E.fromEntries(De([ ...r.filter(([t]) => "@" == t[0]).map(([t, e]) => [ t.slice(1).toLowerCase().trim(), [ e ].flat(1 / 0) ]), ...r.filter(([t]) => t.startsWith("on")).map(([t, e]) => [ t.slice(2).toLowerCase().trim(), [ e ].flat(1 / 0) ]) ])),
            directives: E.fromEntries(o.filter(([t]) => "*" === t[0] || "_" === t[0] || "$" === t[0]).map(([t, e]) => [ t.slice(1).toLowerCase().trim(), e ]))
        }), Ft(s, S.toStringTag, {
            value: "VirtualElement"
        }), Vt(s), Me.add(s), E.freeze(c), s;
    }
    function $e(t) {
        if (U(t)) return !0;
        if (F(t)) return !0;
    ...
    function Qe(t, e, n = !0) {
        return n && Ke(e, ""), le(t).flat(1 / 0).forEach(t => Fe(e, t)), e;
    }
    const Xe = g(26).fill(void 0).map((t, e) => 97 + e).map(t => y.fromCharCode(t)), Ye = g(16).fill(void 0).map((t, e) => e).map(t => t.toString(16)), tn = [ ...new j([ ...Ye, ...Xe ]) ];
    function en(t = 1) {
        return g(t).fill(void 0).map(() => Zt(Xe, T.floor(T.random() * Xe.length))).join("") + "-" + g(t).fill(void 0).map(() => Zt(tn, T.floor(T.random() * tn.length))).join("");
    }
    if (!B(i.customElements)) throw new L;
    i.CustomElementRegistry = Zt(Ut(i.customElements), "constructor");
    const nn = S.for("elementset"), rn = S.for("elementmap"), {CustomElementRegistry: on} = i, sn = i.customElements;
    qt(sn, nn) || O.set(sn, nn, new j), qt(sn, rn) || O.set(sn, rn, {});
    function cn(t, e, n = 1) {
        if (!We(t)) throw L();
        if (Zt(sn, nn).has(t)) return function(t, e) {
            const n = E.entries(t).find(t => t[1] === e);
            return n ? n[0] : void 0;
        }(Zt(sn, rn), t);
        {
            const r = en(n);
            return sn.get(r) ? cn(t, e, n + 1) : (e ? sn.define(r, t, {
                extends: e
            }) : sn.define(r, t), r);
        }
    }
    ...
    sn.define = function(t, e, n) {
        if (!We(e)) throw L();
        Zt(sn, nn).has(e) || (qt(sn[rn], t) ? cn(e, n ? n.extends : void 0) : (on.prototype.define.call(sn, t, e, n), 
        sn[nn].add(e), sn[rn][t] = e));
    }, Jt(sn, S.iterator, () => {
    ...
    function yn(t, e) {
        ...
        if (_e(t)) {
            ...
            if ("string" == typeof o) {
                ...
                if ("svg" === o) i = Be(qe, "svg"); else if ("math" === o) i = Be("http://www.w3.org/1998/Math/MathML", "math"); else {
                    if ("" === o || "html" === o) {
                        const e = ze();
                        return Qe(yn(t.children), e), e;
                    }
                    i = e ? Be(e, o) : function(t) {
            ...
            return o && (q(o) || U(o)) && (q(r = o) && Zt(r, an) === an || i && Qe(t.children.map(t => "svg" === o && _e(t) ? yn(t, qe) : "math" === o && _e(t) ? yn(t, "http://www.w3.org/1998/Math/MathML") : e && _e(t) ? yn(t, e) : yn(t)), i)), 
            i && function(t, e) {
    ...
    function bn(t, e) {
        ...
        const r = le(t);
        if ($e(t)) Qe(yn(r), e); else {
            if (!(gn(t) || (o = t, I(o) && o.length && o.every(t => gn(t))))) throw L();
            Qe(r, e);
        }
        var o;
        return e;
    ...
    function Cn(t, e) {
        return t.map(t => {
            ...
            }(t) ? void xn(e, void 0, t.href) : t;
        }).filter(x);
    }
    function jn(t) {
        const e = yn(Xn("style", [ t ]));
        return Fe(b.implementation.createHTMLDocument("").documentElement, e), g.from(Zt(Zt(e, "sheet"), "cssRules"));
    }
    const Tn = new D;
    function kn(t, e) {
        xn(e, function(t, e) {
    ...
    function Ln(t, e) {
        return C.all([ ...Zt(On, t) ].map(t => {
            return Ge(`link[rel="stylesheet"][href="${t}"]`).length ? C.resolve() : (n = yn(Xn("link", {
                href: t,
                rel: "stylesheet"
            })), r = e, new C(t => {
                const e = () => {
    ...
    function Dn(t) {
        if (I(t)) t.forEach(t => {
            ...
            if (function(t) {
                qt(t, pn) && Zt(t, pn).forEach(([e, n]) => {
                    Ve(t, e, n);
                });
            }(t), qt(t, wn) && Zt(t, wn).forEach(t => {
                de(t), t[se]();
    ...
    class Hn extends HTMLElement {
        constructor() {
            super(), this[_n] = !1;
            const t = Zt(this.constructor, "defaultProps"), e = Te(this);
        ...
        if (q(t)) {
            ...
            class c extends Hn {
                constructor(n = {}, o = []) {
                    ...
                    {
                        const t = le(f);
                        this[In] = t.flat(1 / 0).filter(x), this[Vn] = [ ...Dt ], this[Zn] = [ ...Mt ], 
                        this[Bn] = [ ...Rt ], this[zn] = [ ...Lt ], $t();
                    }
                }
                [(e = Un, n = an, r = Rn, $n)]() {
                    const t = () => (Ke(this, ""), Ln(r, b.head)), e = () => {
            ...
            return c[n] = an, c.css = U(s) && s ? s : void 0, c.defaultProps = B(i) ? N.parse(N.stringify(i)) : void 0, 
            Tt.set(t, c), c;
        }
        throw L();
    }
    ...
    function Yn(t, e = {}, ...n) {
        ...
        return U(r) && (r = r.trim().toLowerCase()), "" === r ? i : Kt(Ae, void 0, [ r, o, i ]);
    }
    const tr = S("truevdom"), er = S("falsevdom"), nr = S("trueele"), rr = S("falseele"), or = S("handletrue"), ir = S("handlefalse"), sr = S("currentelement"), cr = function cr(t, e, n) {
        var r, o, i, s, c;
        if (!re(t) && !z(t)) throw L();
        [ e, n ].forEach(t => {
    ...
    const vr = i.Reflect, {ownKeys: wr, deleteProperty: mr, apply: yr, construct: gr, defineProperty: br, get: Er, getOwnPropertyDescriptor: Or, getPrototypeOf: Pr, has: Sr, set: xr, setPrototypeOf: Cr} = vr;
    function jr(t) {
        return "object" == typeof t && null !== t;
    }
    function Tr(t) {
    ...
    function kr(t, e, n = [], r = t) {
        ...
        if (Tr(t) || jr(t)) {
            let o;
            return dr(t) ? (o = new j([ ...t ]), xr(o, "add", i => (fr.add.call(t, i), e(r, n, void 0, void 0), 
            fr.add.call(o, i))), xr(o, "delete", i => (fr.delete.call(t, i), e(r, n, void 0, void 0), 
            fr.delete.call(o, i))), xr(o, "clear", () => (fr.clear.call(t), e(r, n, void 0, void 0), 
            fr.clear.call(o)))) : hr(t) ? (o = new D([ ...t ]), xr(o, "clear", () => (lr.clear.call(t), 
            e(r, n, void 0, void 0), lr.clear.call(o))), xr(o, "set", (i, s) => (lr.set.call(t, i, s), 
            e(r, n, void 0, void 0), lr.set.call(o, i, s))), xr(o, "delete", i => (lr.delete.call(t, i), 
            e(r, n, void 0, void 0), lr.delete.call(o, i)))) : o = pr(t) ? [] : Tr(t) ? () => {} : {}, 
            dr(t) || hr(t) || Cr(o, null), new P(o, {
                ...
                set: (o, i, s) => (Tr(e) && e(r, [ ...n, y(i) ], s, Er(t, i)), xr(t, i, s)),
                get(r, i) {
                    var s = Er(t, i);
    ...
    function Dr(t) {
        if ($(t) || q(t)) return ur(new P(new fe(t), {
            defineProperty: () => !1,
            deleteProperty: () => !1,
            set(e, n, r) {
    ...
    function $r(t, e) {
        ...
        class c extends Hn {
            ...
            [$n]() {
                ...
                this[_r] = yn(this[Rr]), E.entries(this[_r]).forEach(([t, e]) => {
                    Jt(this[Ar], A(t), e);
                }), Qe(this[_r], this), this[_r] = [], this[Rr] = [];
            }
            connectedCallback() {
                Wn(this);
            }
    ...
    hn({
        ...
        checked(t, e, n) {
            ...
            Jt(n.onevent, "click", le([ ...r, t => {
                ...
                n && Ge(`input[name=${n}]`).filter(t => t !== e).forEach(t => {
    ...
    const element = document.body.appendChild(bn(vdom$3, document.createElement("div")));
    ...
    (() => {
        ...
        document.body.appendChild(bn([ vdom, vdom2, vdom3 ], document.createElement("div")));
    ...
    document.body.appendChild(bn([ Xn(Bqqqqqqqqq), Xn(Aqqqqqqqqq) ], document.createElement("div")));
    console.log([ Xn, Xn ]);
    (() => {
        (() => {
            var _class, _temp;
            ...
            document.body.appendChild(bn(myvdom1111111, document.createElement("div")));
            document.body.appendChild(bn(Xn((() => {
    ...
    (() => {
        ...
        document.body.appendChild(bn(Xn(myclasscomponent, [ Xn("form", {
            id: "newsletterForm",
    ...
    setTimeout(() => {
        Object.values(Object.fromEntries(customElements)).map(c => yn(Xn(c))).forEach(e => document.body.appendChild(e));
    }, 8e3);
    setTimeout(() => {
    ...
    document.body.appendChild(yn(Xn(() => Xn("div", null, Xn("button", {
        $text: "component 1",
        onclick: () => {
            mystate.value = com1;
        }
