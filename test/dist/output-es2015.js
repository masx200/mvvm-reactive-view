(function() {
    ...
    var listlengthsymbol = Symbol("listlength");
            ...
            connectedCallback() {
                ...
                return _asyncToGenerator((function*() {
                    if (!_this7[readysymbol]) {
                        ...
                        _this7[listinnervdom] = value.map((v, i) => ITEMfactory(computed(value, v => v[i]), i));
                        _this7[listinnerelement] = render(_this7[listinnervdom]);
                        mount(_this7[listinnerelement], _this7);
                        _this7[listlengthsymbol] = value.length;
                    }
                    onmounted(_this7);
                }))();
            }
    ...
    var vdom$1 = listmap(liststate, (value, index) => createElement("div", [ "item", "value", value, "index", index ]));
