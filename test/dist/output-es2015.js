(function() {
    ...
    function removelisteners(ele) {
        if (has(ele, eventlistenerssymbol)) {
            get(ele, eventlistenerssymbol).forEach(_ref6 => {
                var [event, call] = _ref6;
    ...
    function readdlisteners(ele) {
        if (has(ele, eventlistenerssymbol)) {
            get(ele, eventlistenerssymbol).forEach(_ref7 => {
                var [event, call] = _ref7;
                domaddlisten(ele, event, call);
            });
        }
    }
    ...
    function merge_entries(a) {
        ...
        return Object$1.entries(m).map(_ref9 => {
            var [k, v] = _ref9;
            return [ k, [ ...v ] ];
        });
    }
    ...
    function createVirtualElement(type) {
        ...
        var propsentriesNOTevents = propsentries.filter(_ref10 => {
            var [key] = _ref10;
            return !(key.startsWith("@") || key.startsWith("on"));
        });
        var \u5b57\u6bcd\u5f00\u5934\u7684entries = propsentriesNOTevents.filter(_ref11 => {
            var [key] = _ref11;
        ...
        Object$1.assign(thisarg, {
            ...
            children: children,
            onevent: Object$1.fromEntries(merge_entries([ ...propsentries.filter(_ref12 => {
                var [key] = _ref12;
                return "@" == key[0];
            }).map(_ref13 => {
                var [key, value] = _ref13;
                return [ key.slice(1).toLowerCase().trim(), [ value ].flat(1 / 0) ];
            }), ...propsentries.filter(_ref14 => {
                var [key] = _ref14;
            ...
            directives: Object$1.fromEntries(propsentriesNOTevents.filter(_ref16 => {
                var [key] = _ref16;
    ...
    function extenddirectives() {
        ...
        Object$1.entries(options).forEach(_ref18 => {
            var [key, value] = _ref18;
    ...
    function onunmounted(ele) {
        if (isarray(ele)) {
            ...
            if (has(ele, innerwatchrecords)) {
                var watchrecords = get(ele, innerwatchrecords);
                watchrecords.forEach(_ref24 => {
                    var [state, callback] = _ref24;
                    var eventlistener = cached_callback_eventlistner.get(callback);
                    if (eventlistener) {
        ...
        if (isfunction(custfun)) {
            ...
            class Component extends AttrChange {
                constructor() {
                    ...
                    var props = attrs;
                    openctx();
                    var thisattributess = Object$1.fromEntries(Object$1.entries(props).map(_ref25 => {
                        var [key, value] = _ref25;
                        return [ key, createstate(value) ];
                    }));
                    this[attributessymbol] = thisattributess;
                    var readonlyprop = readonlyproxy(Object$1.fromEntries(Object$1.entries(thisattributess).map(_ref26 => {
    ...
    function listmap(list, mapfun) {
        ...
        var itemclass = createComponent(Object$1.assign(props => {
            var {value: propvalue, index: propindex} = props;
            var value = propvalue;
            var index = propindex.valueOf();
        ...
        var ITEMfactory = (value, index) => createElement(itemclass, {
            value: value,
            index: index
        });
    ...
    var vdom$1 = createElement("div", null, createElement("button", {
        _text: "push",
        onclick: () => {
    ...
    }), listmap(liststate, (value, index) => createElement("div", {
        _ref: ele => {
    ...
    mycomapp$1.css = css;
    var vdom$2 = createElement(mycomapp$1);
    MountElement(vdom$2, document.getElementById("root"));
    console.log([ createElement, createElement ]);
    var vdom$3 = createElement("select", {
        ...
        value: "0"
    }, "- Select version -"), createElement("option", {
        value: "94b92331-e2f4-40c6-90ee-80e203a4de3a"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [arm64]"), createElement("option", {
        value: "7268dbc9-dfe0-4947-af82-67f384e95cb6"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x64]"), createElement("option", {
        value: "08f0d32e-c68a-46a8-b301-57e86b4e96e0"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x86]"), createElement("option", {
        value: "9fa87c7f-75fa-4e5e-9ca3-1e19cb2c743f"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x64]"), createElement("option", {
        value: "5173796c-11ac-47d7-9ed7-dbad6d5c9486"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x86]"), createElement("option", {
        value: "4adf5f24-213a-472c-ae94-70f3cb81bade"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [arm64]"), createElement("option", {
        value: "9287fe5e-2cb3-4064-820f-3e336a3ddff4"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [arm64]"), createElement("option", {
        value: "5e420f0d-b3a5-424c-9b55-5c2cf939af14"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [x86]"), createElement("option", {
    ...
    {
        var vdom$6 = createElement("div", [ [ createElement("html", null, "testhtml"), createElement("button", {
            onclick: [ console.log, () => {
                console.log("onclick");
            } ],
            "*text": "clicktest",
    ...
    (() => {
        var mycom = createComponent(Object.assign((props, children) => {
            ...
            }, [ number, createElement("br", null), "wwwwwwwwwwww", createElement("div", [ "createComponent" ]), children, createElement("div", createElement("", null, "props cccccc ", props.cccccc)) ]);
        }, {
            defaultProps: {
                cccccc: "bbbbbbb"
            },
        ...
        document.body.appendChild(MountElement(createElement(myclasscomponent, [ createElement("form", {
            id: "newsletterForm",
    ...
    setTimeout(() => {
        Object.values(Object.fromEntries(customElements)).map(c => render(createElement(c))).forEach(e => document.body.appendChild(e));
    }, 8e3);
    setTimeout(() => {
