(function() {
    ...
    var Q = function(t) {
        ...
        X =
            void 0 !== t
                ...
                ? e
                : {},
        Y = "object" == typeof X && X && X.Object === y && X,
        tt = "object" == typeof e && e && e.Object === y && e,
        et = Y || tt || Function("return this")(),
        nt = function() {
            return et.Date.now();
        },
        rt = et.Symbol,
    ...
    var pt = function(t) {
            return (
                "symbol" == typeof t || (dt(t) && "[object Symbol]" == ht(t))
            );
        },
        vt = /^\s+|\s+$/g,
        wt = /^[-+]0x[0-9a-f]+$/i,
    ...
    var Ot = function(t, e, n) {
        ...
        return (
            ...
            Q(n) &&
                ((f = !!n.leading),
                (i = (l = "maxWait" in n) ? Et(bt(n.maxWait) || 0, e) : i),
    ...
    var Vt, Zt, Jt;
    const Gt = E("addonelistner"),
        Qt = E("removeonelistner"),
        Xt = E("cancelsubscribe"),
        Yt = E("debouncedispatch");
    function te(t) {
        return t instanceof ce && "ReactiveState" === t[E.toStringTag];
    }
    const ee = E("eventtatget"),
        ne = E("memlisteners"),
        re = E("dispatch"),
        oe = E("subscribe"),
        ie = E("removeallisteners"),
        se = E("addallisteners");
    class ce {
        constructor(t) {
            var e;
    ...
    var he = (t, e, n) =>
        ("value" === e && le.includes(t) && "button" !== n) ||
        ("selected" === e && "option" === t) ||
        ("checked" === e && "input" === t) ||
        ("muted" === e && "video" === t);
    const de = /\B([A-Z])/g,
        pe = t => t.replace(de, "-$1").toLowerCase(),
        ve = n.String,
        we = n.Reflect,
        { get: me, set: ye, ownKeys: ge } = we;
    function be(t) {
        return "object" == typeof t && null !== t;
    }
    function Ee(t) {
    ...
    const Oe = t =>
        "input" === Se(t) &&
        ("checkbox" === me(t, "type") || "radio" === me(t, "type"));
    function Se(t) {
    ...
    function Le(t) {
        ...
        const n = new b(e, {
            ownKeys() {
                ...
                return w.from(
                    new S(
                        [...n, Oe(t) ? "checked" : void 0, e ? "value" : void 0]
                            .flat(1 / 0)
                            .filter(t => !!t)
                    )
                );
            ...
            set(e, n, r) {
                ...
                return !1 === r || null == r
                    ? (Ce(t, ve(n)), !0)
                    : Pe(r)
                    ? (xe(t, ve(n), T.stringify([...r])), !0)
                    : (!0 === r && (r = ""),
                      xe(t, ve(n), be(r) ? T.stringify(r) : ve(r)),
                      !0);
                var o, i;
            },
    ...
    function Ge(t = 1) {
        return (
            w(t)
                .fill(void 0)
                .map(() => qt(Ve, x.floor(x.random() * Ve.length)))
                .join("") +
            "-" +
            w(t)
                .fill(void 0)
                .map(() => qt(Je, x.floor(x.random() * Je.length)))
                .join("")
        );
    }
    if (!H(n.customElements)) throw new L();
    n.CustomElementRegistry = qt(Ft(n.customElements), "constructor");
    const Qe = E.for("elementset"),
        Xe = E.for("elementmap"),
        { CustomElementRegistry: Ye } = n,
        tn = n.customElements;
    ...
    (tn.define = function(t, e, n) {
        ...
        qt(tn, Qe).has(e) ||
            (zt(tn[Xe], t)
                ? en(e, n ? n.extends : void 0)
                : (Ye.prototype.define.call(tn, t, e, n),
                  tn[Qe].add(e),
                  (tn[Xe][t] = e)));
    }),
        It(tn, E.iterator, () => {
        ...
        It(i.bindattr, e, o),
            r.forEach(t => {
                ...
                It(
                    i.onevent,
                    t,
                    ue([...e, t => (o.value = qt(t.target, n))]).filter(P)
                );
            });
    }
    cn("ref", (t, e, n) => {
        if (z(n)) Dt(n, void 0, [t]);
        else {
            if (!H(n)) throw L();
            It(n, "value", t);
        }
    ...
    function pn(t, e) {
        ...
        if (Ne(t)) {
            ...
            if ("string" == typeof n) {
                ...
                if ("svg" === n) r = Ke(Fe, "svg");
                else if ("math" === n)
                    r = Ke("http://www.w3.org/1998/Math/MathML", "math");
                else {
                    if ("" === n || "html" === n) {
                        const e = We();
    ...
    function wn(t, e) {
        ...
        if (Re(t)) Ie(pn(r), e);
            ...
            if (!(vn(t) || ((o = t), B(o) && o.length && o.every(t => vn(t)))))
                throw L();
            Ie(r, e);
        }
        var o;
    ...
    function On(t) {
        ...
        return (
            $e(m.implementation.createHTMLDocument("").documentElement, e),
            w.from(qt(qt(e, "sheet"), "cssRules"))
        );
    }
    const Sn = new j();
    function xn(t, e) {
    ...
    function Cn(t, e) {
        return O.all(
            [...qt(yn, t)].map(t => {
                return qe(`link[rel="stylesheet"][href="${t}"]`).length
                    ? O.resolve()
                    : ((n = pn(
                          Zn("link", {
                              href: t,
    ...
    class Dn extends HTMLElement {
        constructor() {
            super(), (this[Nn] = !1);
            const t = qt(this.constructor, "defaultProps"),
                e = Le(this);
            H(t) && y.assign(e, t),
    ...
    Nn = kn;
    const $n = E("waittranformcss"),
        Wn = E("innerwatchrecord"),
        Kn = E("innerstate"),
        Hn = E("attributes"),
        Fn = E("innerelement"),
        zn = E("innervdom"),
        ...
        if (z(t)) {
            ...
            class c extends Dn {
                constructor(n = {}, o = []) {
                    ...
                    this[Hn] = u;
                    const a = mn(
                        y.fromEntries(y.entries(u).map(([t, e]) => [t, mn(e)]))
                    );
                    let f;
                    try {
                ...
                [((e = Hn), (n = rn), (r = kn), Rn)]() {
                    ...
                    const n = qt(this.constructor, "css"),
            ...
            return (
                (c[n] = rn),
                (c.css = F(s) && s ? s : void 0),
                (c.defaultProps = H(i) ? T.parse(T.stringify(i)) : void 0),
                St.set(t, c),
                c
            );
        }
    ...
    function Zn(t, e, ...n) {
        return (
            z(t) && (t = Vn(t)),
            B(e)
                ? Dt(Jn, void 0, [t, void 0, [...e, ...n].flat(1 / 0)])
                : Dt(Jn, void 0, [t, e, ...n])
        );
    }
    function Jn(t, e = {}, ...n) {
        ...
        const o = D(e) ? e : {},
            i = n
                ...
                .filter(t => !!t);
        return (
            F(r) && (r = r.trim().toLowerCase()),
            "" === r ? i : Dt(Me, void 0, [r, o, i])
        );
    }
    const Gn = E("truevdom"),
        Qn = E("falsevdom"),
    ...
    function Mr(t) {
        if (A(t) || z(t))
            return ur(
                new b(new ce(t), {
                    ...
                    deleteProperty: () => !1,
                    set(e, n, r) {
                        if ("value" === n && ((A(r) && A(t)) || (z(r) && z(t))))
                            return e[n] !== r && (It(e, n, r), e[re]()), !0;
                        throw L();
                    },
                    setPrototypeOf: () => !1
                })
        ...
        if (H(t))
            return (function(t) {
                const e = new ce(t);
                let n = t;
                const r = D(t) && y.values(t).some(t => te(t)),
                    o = y.entries(t).filter(t => te(t[1]));
                r &&
                    ((n = y.assign({}, t)),
                    o.forEach(([t, e]) => {
                        Wt(n, t, {
                ...
                const i = {
                    ownKeys: t =>
                        w.from(new S([...Bt(t), ...Bt(qt(t, "value"))])),
                    setPrototypeOf: () => !1,
                    defineProperty: () => !1,
                    getOwnPropertyDescriptor: (t, e) => {
                        if (_(e)) return;
    ...
    const mycomapp = In(() => {
        ...
        return Zn(
            ...
            Zn("h2", null, "x:", x),
            Zn("h1", null, "y:", y),
            Zn("p", null, "x+100 \u662f", plus),
            Zn("p", null, "x*y \u662f", multi)
        );
    });
    ...
    const vdom$1 = [
        rr(weathercondition, testlistvdom),
        Zn(
            "",
            null,
            Zn(
    ...
    const element = document.body.appendChild(
        wn(vdom$3, document.createElement("div"))
    );
    ...
    const mycomappclass = In(() => {
        ...
        const vdom = Zn(
            ...
            null,
            Zn("h3", null, " \u70b9\u51fb\u6570\u5b57"),
            Zn("h2", null, "number:", store.number),
            Zn(
                "button",
                {
    ...
    (() => {
        ...
        var vdom2 = rr(
            mystate,
            undefined,
            Zn("div", undefined, "testwwwwwwwwwfalese")
        );
        var vdom3 = rr(
            mystate,
            Zn("div", undefined, "testwwwwwwwtrueeeeeeeeee"),
            undefined
        );
        console.log([vdom, vdom2, vdom3]);
        document.body.appendChild(
            wn([vdom, vdom2, vdom3], document.createElement("div"))
        );
        ...
        var vdom = Zn(
            ...
            Zn(
                ...
                Zn(
                    "mrow",
                    null,
                    Zn("msup", null, Zn("mi", null, "a"), Zn("mn", null, "2")),
                    Zn("mo", null, "+"),
                    Zn("msup", null, Zn("mi", null, "b"), Zn("mn", null, "2"))
                ),
                Zn("mo", null, "="),
                Zn("msup", null, Zn("mi", null, "c"), Zn("mn", null, "2"))
            )
        );
        document.body.appendChild(wn(vdom, document.createElement("div")));
        console.log(vdom);
    ...
    document.body.appendChild(
        wn([Zn(Bqqqqqqqqq), Zn(Aqqqqqqqqq)], document.createElement("div"))
    );
    ...
    (() => {
        (() => {
            ...
            document.body.appendChild(
                wn(myvdom1111111, document.createElement("div"))
            );
            document.body.appendChild(
                wn(
                    Zn(
            ...
            console.log(myele1);
            document.body.appendChild(
                wn(myele1, document.createElement("div"))
            );
            document.body.appendChild(
                wn(myele1, document.createElement("div"))
            );
    ...
    (async () => {
        ...
        document.body.appendChild(
            wn([vdom, vdom1], document.createElement("div"))
        );
        console.log([
            "\u6d4b\u8bd5\u4e0d\u4f7f\u7528createComponent",
            Hellowordclass,
                ...
                (props, children) => {
                    ...
                    return Zn(
                        ...
                        [
                            ...
                            Zn("br", null),
                            "wwwwwwwwwwww",
                            Zn("div", ["createComponent"]),
                            children,
                            Zn(
                                "div",
                                Zn("", null, "props cccccc ", props.cccccc)
                            )
                        ]
                    );
                },
