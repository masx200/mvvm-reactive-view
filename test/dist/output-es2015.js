(function() {
    ...
    function q(t) {
        return X(t) || J(t) || G(t) || Z(t) || function(t) {
    ...
    const {apply: it, construct: st, defineProperty: ct, deleteProperty: ut, getOwnPropertyDescriptor: at, getPrototypeOf: ft, has: lt, ownKeys: ht, preventExtensions: dt} = g;
    function pt(t, e) {
    ...
    }, gt = void 0 !== t ? t : void 0 !== n ? n : void 0 !== r ? r : void 0 !== e ? e : {}, bt = "object" == typeof gt && gt && gt.Object === y && gt, Et = "object" == typeof e && e && e.Object === y && e, Pt = bt || Et || Function("return this")(), Ot = function() {
        return Pt.Date.now();
    }, St = Pt.Symbol, xt = y.prototype, Ct = xt.hasOwnProperty, Lt = xt.toString, Tt = St ? St.toStringTag : void 0;
    var jt = function(t) {
        var e = Ct.call(t, Tt), n = t[Tt];
        try {
            t[Tt] = void 0;
            var r = !0;
        } catch (t) {}
    ...
    var Rt = function(t) {
        return null == t ? void 0 === t ? "[object Undefined]" : "[object Null]" : Mt && Mt in y(t) ? jt(t) : Nt(t);
    };
    var At = function(t) {
        return null != t && "object" == typeof t;
    };
    var _t = function(t) {
        return "symbol" == typeof t || At(t) && "[object Symbol]" == Rt(t);
    }, Dt = /^\s+|\s+$/g, $t = /^[-+]0x[0-9a-f]+$/i, Wt = /^0b[01]+$/i, Kt = /^0o[0-7]+$/i, Ht = M;
    var Ft = function(t) {
        ...
        t = t.replace(Dt, "");
        var n = Wt.test(t);
        return n || Kt.test(t) ? Ht(t.slice(2), n ? 2 : 8) : $t.test(t) ? NaN : +t;
    }, zt = x.max, Bt = x.min;
    var Ut = function(t, e, n) {
        ...
        return e = Ft(e) || 0, yt(n) && (f = !!n.leading, i = (l = "maxWait" in n) ? zt(Ft(n.maxWait) || 0, e) : i, 
    ...
    let qt = [];
    let It = !1, Vt = new S, Zt = new S, Jt = new S;
    function Gt(t) {
        if (!Y(t)) throw L();
        if (!It) throw C();
        Vt.add(t);
    ...
    var te, ee, ne;
    const re = E("addonelistner"), oe = E("removeonelistner"), ie = E("cancelsubscribe"), se = E("debouncedispatch");
    function ce(t) {
        return t instanceof pe && "ReactiveState" === t[E.toStringTag];
    }
    const ue = E("eventtatget"), ae = E("memlisteners"), fe = E("dispatch"), le = E("subscribe"), he = E("removeallisteners"), de = E("addallisteners");
    class pe {
        constructor(t) {
            var e;
            this[E.toStringTag] = "ReactiveState", this[te] = (() => {
                const t = Ut(() => {
                    this[ue].dispatch();
                });
                return () => {
            ...
            })(), this[ee] = new mt, this[ne] = new S, this.valueOf = () => this.value, this.value = t, 
            ct(this, "value", {
                value: t,
                configurable: !0,
                writable: !0
        ...
        toString() {
            ...
            return q(t) ? v(t) : nt(t) ? T.stringify([ ...t ]) : Q(t) ? T.stringify(t) : "";
        }
        [(ee = ue, ne = ae, fe)]() {
            this[se]();
        }
    ...
    const ge = /\B([A-Z])/g, be = t => t.replace(ge, "-$1").toLowerCase(), Ee = n.String, Pe = n.Reflect, {get: Oe, set: Se, ownKeys: xe} = Pe;
    function Ce(t) {
        return "object" == typeof t && null !== t;
    }
    function Le(t) {
    ...
    function We(t, e = {}, n = []) {
        ...
        return [ "onevent", "element", "type", "props", "children", "directives", "bindattr" ].forEach(t => {
            ...
            props: y.fromEntries(i.filter(t => !ce(t[1])).map(([t, e]) => [ t, X(e) ? e.trim() : e ])),
            children: n,
    ...
    function Fe(t, e, n = !0) {
        return n && A(e, ""), wt(t).flat(1 / 0).forEach(t => D(e, t)), e;
    }
    ...
    function qe(t = 1) {
        return w(t).fill(void 0).map(() => pt(ze, x.floor(x.random() * ze.length))).join("") + "-" + w(t).fill(void 0).map(() => pt(Ue, x.floor(x.random() * Ue.length))).join("");
    }
    ...
    function Ge(t, e, n = 1) {
        if (!He(t)) throw L();
        if (pt(Je, Ie).has(t)) return function(t, e) {
    ...
    function Qe(t, e, n) {
        let r = t;
        if (Y(r) && (r = Kn(r)), He(t = r)) return ((t, e) => {
            Ge(t, e);
        })(t), st(t, [ e, n ]);
        throw L();
    }
    Je.define = function(t, e, n) {
        if (!He(e)) throw L();
        pt(Je, Ie).has(e) || (lt(Je[Ve], t) ? Ge(e, n ? n.extends : void 0) : (Ze.prototype.define.call(Je, t, e, n), 
    ...
    function Ye(t) {
        ...
        return G(e) ? e : m.documentElement === function(t) {
    ...
    function sn(t, e) {
        ...
        if ($e(t)) {
            ...
            if ("string" == typeof n) {
                if ("script" === n) return $();
                if ("svg" === n) r = W(H, "svg"); else if ("math" === n) r = W("http://www.w3.org/1998/Math/MathML", "math"); else {
                    if ("" === n || "html" === n) {
                        const e = $();
                        return Fe(sn(t.children), e), e;
                    }
                    r = e ? W(e, n) : function(t) {
                        return m.createElement(t);
                    }(n);
                }
            } else if ("function" == typeof n) {
                Q(n.defaultProps) && y.assign(t.props, T.parse(T.stringify({
                    ...n.defaultProps,
                    ...t.props
                })));
            ...
            return n && (Y(n) || X(n)) && (function(t) {
                return Y(t) && pt(t, Xe) === Xe;
            }(n) || r && Fe(t.children.map(t => "svg" === n && $e(t) ? sn(t, H) : "math" === n && $e(t) ? sn(t, "http://www.w3.org/1998/Math/MathML") : e && $e(t) ? sn(t, e) : sn(t)), r)), 
            r && function(t, e) {
                ...
                })(t, e), [ ...y.values(e.bindattr), ...y.values(e.directives) ].flat(1 / 0).filter(t => ce(t)).forEach(e => {
                    lt(t, rn) || vt(t, rn, new S), pt(t, rn).add(e);
                });
            }(r, t), r;
        }
        on();
    ...
    function un(t, e) {
        ...
        const r = wt(t);
        if (Ke(t)) Fe(sn(r), e); else {
            if (!(cn(t) || (o = t, tt(o) && o.length && o.every(t => cn(t))))) throw L();
            Fe(r, e);
        }
        var o;
        return e;
    ...
    function dn(t, e, n) {
        ...
        pt(fn, r) || vt(fn, t, new S), e ? pt(fn, r).add(function(t) {
            const e = hn.get(t);
            if (e) return e;
            {
    ...
    function pn(t, e) {
        return t.map(t => {
            ...
            return function(t) {
                ...
                return {
                    cssText: t.cssText.slice(0, 7) + r + "{" + ln(n) + "}",
                    conditionText: r,
                    cssRules: n,
            ...
            }(t) ? void dn(e, void 0, t.href) : t;
        }).filter(P);
    }
    function vn(t) {
        const e = sn(Hn("style", [ t ]));
        return D(m.implementation.createHTMLDocument("").documentElement, e), w.from(pt(pt(e, "sheet"), "cssRules"));
    }
    const wn = new j;
    function mn(t, e) {
        dn(e, function(t, e) {
    ...
    function yn(t, e) {
        return O.all([ ...pt(fn, t) ].map(t => {
            return U(`link[rel="stylesheet"][href="${t}"]`).length ? O.resolve() : (n = sn(Hn("link", {
                href: t,
                rel: "stylesheet"
            })), r = e, new O(t => {
                const e = () => {
    ...
    function bn(t) {
        if (tt(t)) t.forEach(t => {
            ...
            if (function(t) {
                lt(t, en) && pt(t, en).forEach(([e, n]) => {
                    z(t, e, n);
                });
            }(t), lt(t, rn) && pt(t, rn).forEach(t => {
                Qn(t), t[fe]();
            }), lt(t, Nn) && pt(t, Nn).forEach(t => {
                Qn(t);
            }), lt(t, kn)) {
                pt(t, kn).forEach(([t, e]) => {
                    e && t[re](e);
    ...
    var On;
    const Sn = E("attributeChanged"), xn = E("firstinstalled");
    function Cn(t) {
    ...
    class Tn extends HTMLElement {
        constructor() {
            super(), this[On] = !1;
            const t = pt(this.constructor, "defaultProps"), e = Re(this);
            Q(t) && y.assign(e, t), new MutationObserver(t => {
                t.forEach(t => {
    ...
    On = Pn;
    const jn = E("waittranformcss"), kn = E("innerwatchrecord"), Nn = E("innerstate"), Mn = E("attributes"), Rn = E("innerelement"), An = E("innervdom"), _n = E("mounted"), Dn = E("unmounted");
    function $n(t) {
        var e, n, r;
        if (Y(t)) {
            const o = ve.get(t);
            if (o) return o;
            const i = pt(t, "defaultProps"), s = pt(t, "css");
            class c extends Tn {
                constructor(n = {}, o = []) {
                    ...
                    if (i) {
                        ...
                        pt(fn, t) || (vt(fn, t, new S), this[jn] = () => gn(() => {
                            mn(i, t);
                        }));
                    }
                    const s = Re(this);
                    ...
                    this[Mn] = u;
                    const a = an(y.fromEntries(y.entries(u).map(([t, e]) => [ t, an(e) ])));
                    let f;
                    try {
                    ...
                    {
                        const t = wt(f);
                        this[An] = t.flat(1 / 0).filter(P), this[_n] = [ ...Vt ], this[Dn] = [ ...Zt ], 
                        this[Nn] = [ ...Jt ], this[kn] = [ ...qt ], Xt();
                    }
                }
                [(e = Mn, n = Xe, r = Pn, xn)]() {
                    const t = () => (A(this, ""), yn(r, m.head)), e = () => {
                    ...
                    const n = pt(this.constructor, "css"), r = this.tagName.toLowerCase();
                    if (n) {
                        const n = this[jn];
            ...
            return c[n] = Xe, c.css = X(s) && s ? s : void 0, c.defaultProps = Q(i) ? T.parse(T.stringify(i)) : void 0, 
            ve.set(t, c), c;
        }
        throw L();
    }
    ...
    function Hn(t, e, ...n) {
        return Y(t) && (t = Kn(t)), tt(e) ? it(Fn, void 0, [ t, void 0, [ ...e, ...n ].flat(1 / 0) ]) : it(Fn, void 0, [ t, e, ...n ]);
    }
    function Fn(t, e = {}, ...n) {
        let r = X(t) || Y(t) ? t : "";
        const o = V(e) ? e : {}, i = n.flat(1 / 0).map(t => 0 === t ? "0" : t).filter(t => !!t);
        return X(r) && (r = r.trim().toLowerCase()), "" === r ? i : it(We, void 0, [ r, o, i ]);
    }
    const zn = E("truevdom"), Bn = E("falsevdom"), Un = E("trueele"), qn = E("falseele"), In = E("handletrue"), Vn = E("handlefalse"), Zn = E("currentelement"), Jn = function(t, e, n) {
        var r, o, i, s, c;
        if (!ce(t) && !G(t)) throw L();
        [ e, n ].forEach(t => {
        ...
        class f extends Tn {
            constructor() {
                super(...arguments), this[r] = this, this[i] = !1, this[s] = wt(u), this[c] = wt(a);
            }
            ...
            [xn]() {
                const e = t => {
                    !0 === t ? pt(this, In).call(this) : t || pt(this, Vn).call(this);
                };
                ce(t) ? (e(t.valueOf()), Gn(t, t => {
                    e(t);
                })) : e(t);
            }
            connectedCallback() {
    ...
    function tr(t, e, n, r, o, i) {
        ...
        vt(i.bindattr, e, o), r.forEach(t => {
            const e = wt(i.onevent[t]);
            vt(i.onevent, t, wt([ ...e, t => o.value = pt(t.target, n) ]).filter(P));
        });
    }
    Yn("ref", (t, e, n) => {
        if (Y(n)) it(n, void 0, [ t ]); else {
            if (!Q(n)) throw L();
            vt(n, "value", t);
        }
    }), Yn("html", (t, e, n) => {
        ...
        tr([ "input", "textarea", "select" ], "value", "value", [ "change", "input" ], n, e);
    }), Yn("checked", (t, e, n) => {
        tr([ "input" ], "checked", "checked", [ "change" ], n, e);
        const r = wt(e.onevent.click);
        vt(e.onevent, "click", wt([ ...r, t => {
            const e = t.target, n = t.target.name;
            n && U(`input[name=${n}]`).filter(t => t !== e).forEach(t => {
    ...
    const or = E("cancel_watch"), ir = E("cached_class_element"), sr = E("switch_mount");
    function cr(t) {
        var e, n, r;
        if (!ce(t)) throw new L;
        class o extends Tn {
    ...
    function ur(t) {
        return new b(t, {
            ...
            has(t, e) {
                const n = pt(t, "value"), r = Q(n) ? n : n.__proto__;
                return lt(t, e) || lt(r, e);
            },
            get(t, e) {
                if (lt(t, e)) return pt(t, e);
                {
                    const n = pt(t, "value"), r = y(n);
                    if (lt(r, e)) {
                        const t = pt(r, e);
    ...
    const ar = function(t, e, n) {
        ...
        return function(t, e, n) {
            const r = new pe, o = () => {
                const n = it(e, void 0, t.map(t => t.valueOf())), r = ce(n) ? n.valueOf() : n;
                if (Q(r) || q(r)) return r;
                throw L();
            };
            let i = o();
    ...
    function Mr(t) {
        if (q(t) || Y(t)) return ur(new b(new pe(t), {
            defineProperty: () => !1,
            deleteProperty: () => !1,
            set(e, n, r) {
                if ("value" === n && (q(r) && q(t) || Y(r) && Y(t))) return e[n] !== r && (vt(e, n, r), 
                e[fe]()), !0;
                throw L();
            },
            setPrototypeOf: () => !1
        ...
        if (Q(t)) return function(t) {
            const e = new pe(t);
            let n = t;
            const r = V(t) && y.values(t).some(t => ce(t)), o = y.entries(t).filter(t => ce(t[1]));
            ...
            const i = {
                ownKeys: t => w.from(new S([ ...ht(t), ...ht(pt(t, "value")) ])),
                setPrototypeOf: () => !1,
                defineProperty: () => !1,
                getOwnPropertyDescriptor: (t, e) => {
                    if (I(e)) return;
                    const n = pt(t, "value"), r = at(t, e) || at(n, e);
                ...
                get: (t, e) => {
                    const n = pt(t, "value"), r = tt(n) || V(n);
                    if ("value" === e && r) return kr(pt(t, e), (e, n) => {
                        t[fe]();
                    });
                    if (lt(t, e)) return pt(t, e);
                    if (lt(n, e)) {
                        const o = pt(n, e);
                        if (!nt(n)) return r && (tt(o) || V(o)) ? kr(o, () => {
                            t[fe]();
                        }) : o;
                        if ("add" !== e && "clear" !== e && "delete" !== e) return Y(o) ? o.bind(n) : o;
                        switch (e) {
                          case "add":
                            return (r => {
                                if (!Nr.has.call(n, r)) {
                ...
                set: (e, n, r) => {
                    ce(r) && (r = r.valueOf());
                    const o = pt(e, "value");
                    if ("value" === n && Q(r) && (tt(t) && tt(r) || !tt(t) && !tt(r))) return e[n] !== r && (vt(e, n, r), 
                    e[fe]()), !0;
                    if (lt(e, n)) throw L();
    ...
    const mycomapp = Wn(() => {
        ...
        return Hn("div", null, Hn("h3", null, " \u9f20\u6807\u4f4d\u7f6e"), Hn("h2", null, "x:", x), Hn("h1", null, "y:", y), Hn("p", null, "x+100 \u662f", plus), Hn("p", null, "x*y \u662f", multi));
    });
    ...
    const testlistvdom = Hn("div", null, Hn("button", {
        $text: "push",
        onclick: () => {
    ...
    const vdom$1 = [ Jn(weathercondition, testlistvdom), Hn("", null, Hn("button", {
        onclick: () => {
    ...
    const mycomapp$1 = Wn(() => {
        ...
        const vdom = [ Hn("h1", {
            ...
            style: "\n      width: 100%;\n      height: 200px;\n  "
        }, Hn("title", null, "logo-on-dark-bg"), Hn("rect", {
            Color: "#FFF",
            x: "0",
            y: "0",
            width: "3046.7",
        ...
        }))), Hn("div", null, Hn("div", null, Hn("noscript", null, "You need to enable JavaScript to run this app."), Hn("div", {
            id: "root"
        }, Hn("div", null, Hn("div", {
            ...
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/picalc"
        }, "\u5706\u5468\u7387\u8ba1\u7b97\u591a\u7ebf\u7a0b")), Hn("li", null, Hn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/react-huami"
        }, "\u82b1\u5bc6\u7f51\u9875\u7248")), Hn("li", null, Hn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/decoder"
        }, "JSfuck-and-hieroglyphy-Decoder")), Hn("li", null, Hn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/jsfuck"
        }, "JSfuck-ENCODER")), Hn("li", null, Hn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/hieroglyphy"
        }, "hieroglyphy-ENCODER")), Hn("li", null, Hn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
        ...
        }, "\u52a8\u6001\u5f02\u6b65\u52a0\u8f7d-commonjs\u548cumd\u548camd\u6a21\u5757\u5e93")), Hn("li", {
            class: "nav-item"
        }, Hn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/react-simple-global-state-store-hook"
        }, "\u9002\u7528\u4e8eReact\u7684\u6781\u7b80\u5168\u5c40\u72b6\u6001\u7ba1\u7406\u5e93")), Hn("li", {
            class: "nav-item"
        }, Hn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
        ...
        }, "\u9002\u7528\u4e8eVue\u7684\u6781\u7b80\u5168\u5c40\u72b6\u6001\u7ba1\u7406\u5e93")), Hn("li", null, Hn("a", {
            href: "./my-vue-router-project/index.html",
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined"
        }, "\u57fa\u4e8evue\u7684\u4e3b\u9875")), Hn("li", null, Hn("a", {
        ...
        }, Hn("h1", null, "\u82b1\u5bc6 \u4e0d\u4e00\u6837\u7684\u5bc6\u7801\u7ba1\u7406\u5de5\u5177"), Hn("div", {
            id: "rong1",
            class: "container",
            style: "text-align: center;"
        }, Hn("div", {
            id: "rong2"
        }, Hn("h2", null, Hn("span", null, "1"), "\u8f93\u5165"), Hn("div", {
            id: "input"
        }, Hn("p", null), Hn("h3", null, "\u8bb0\u5fc6\u5bc6\u7801"), Hn("p", null), Hn("p", null, Hn("input", {
            "*ref": inputref,
            ...
            value: ""
        })), Hn("p", null), Hn("span", null, "+"), Hn("h3", null, "\u533a\u5206\u4ee3\u53f7"), Hn("p", null), Hn("p", null, Hn("input", {
            "*ref": inputref2,
            "*value": inputpassword,
            "@input": e => console.log(e),
            id: "key",
            ...
            class: "col-lg-12 col-md-12 col-sm-12 col-xs-12 form-control",
            value: ""
        }))), Hn("br", null), Hn("p", null), Hn("h2", null, Hn("span", null, "2"), "\u83b7\u53d6"), Hn("p", null), Hn("div", {
            id: "get"
        }, Hn("p", {
            id: "tuijian"
        }), Hn("p", null), Hn("h3", null, "\u6700\u7ec8\u5bc6\u7801"), Hn("p", null), Hn("span", {
            id: "myhezi"
        }, Hn("p", null, Hn("input", {
            ...
            value: ""
        })), Hn("br", null), Hn("p", null, Hn("button", {
            id: "copycode16",
            "data-clipboard-target": "#code16",
            class: "btn btn-lg btn copycode16d btn-info",
            style: "width: 100%;"
        }, "\u70b9\u51fb\u590d\u5236"))), Hn("p", null, Hn("span", {
            id: "copyOK",
            style: "display: none;"
        }, "\u221a\u590d\u5236\u6210\u529f")), Hn("p", null)))))))), Hn("script", {
    ...
    const vdom$3 = Hn("select", {
        ...
        value: "0"
    }, "- Select version -"), Hn("option", {
        value: "94b92331-e2f4-40c6-90ee-80e203a4de3a"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [arm64]"), Hn("option", {
        value: "7268dbc9-dfe0-4947-af82-67f384e95cb6"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x64]"), Hn("option", {
        value: "08f0d32e-c68a-46a8-b301-57e86b4e96e0"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x86]"), Hn("option", {
        value: "9fa87c7f-75fa-4e5e-9ca3-1e19cb2c743f"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x64]"), Hn("option", {
        value: "5173796c-11ac-47d7-9ed7-dbad6d5c9486"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x86]"), Hn("option", {
        value: "4adf5f24-213a-472c-ae94-70f3cb81bade"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [arm64]"), Hn("option", {
        value: "9287fe5e-2cb3-4064-820f-3e336a3ddff4"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [arm64]"), Hn("option", {
        value: "5e420f0d-b3a5-424c-9b55-5c2cf939af14"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [x86]"), Hn("option", {
        value: "13e2104c-c98c-43b2-b232-9b2a4b5af2ac"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [x64]"));
    const element = document.body.appendChild(un(vdom$3, document.createElement("div")));
    ...
    const mycomappclass = Wn(() => {
        ...
        const vdom = Hn("div", null, Hn("h3", null, " \u70b9\u51fb\u6570\u5b57"), Hn("h2", null, "number:", store.number), Hn("button", {
    ...
    var vdom$5 = Hn("", null, Hn("input", {
        ...
        type: "checkbox",
        $checked: notcheck
    }), Hn("", null, Hn("ul", null, list.map((a, index) => Hn("li", {
        $ref: ele => {
            lirefs[index] = ele;
        ...
        class: "title"
    }, "\u4f60\u7684\u4ed3\u5e93 masx200/mvvm-reactive-view \u5df2\u7ecf\u4ece https://github.com/masx200/mvvm-reactive-view.git \u540c\u6b65\u6210\u529f"), Hn("div", {
        class: "meta"
    }, Hn("time", {
        class: "timeago"
    }, "2\u5c0f\u65f6\u524d"), " ", "\xb7", " ", Hn("span", {
        class: "namespace"
    }, "masx200/mvvm-reactive-view")))), Hn("div", {
    ...
    (() => {
        ...
        var vdom2 = Jn(mystate, undefined, Hn("div", undefined, "testwwwwwwwwwfalese"));
        var vdom3 = Jn(mystate, Hn("div", undefined, "testwwwwwwwtrueeeeeeeeee"), undefined);
        console.log([ vdom, vdom2, vdom3 ]);
        document.body.appendChild(un([ vdom, vdom2, vdom3 ], document.createElement("div")));
    ...
    (() => {
        var vdom = Hn("math", null, Hn("mrow", null, Hn("mrow", null, Hn("msup", null, Hn("mi", null, "a"), Hn("mn", null, "2")), Hn("mo", null, "+"), Hn("msup", null, Hn("mi", null, "b"), Hn("mn", null, "2"))), Hn("mo", null, "="), Hn("msup", null, Hn("mi", null, "c"), Hn("mn", null, "2"))));
        document.body.appendChild(un(vdom, document.createElement("div")));
        console.log(vdom);
    })();
    ...
    document.body.appendChild(un([ Hn(Bqqqqqqqqq), Hn(Aqqqqqqqqq) ], document.createElement("div")));
    ...
    (() => {
        (() => {
            var _class, _temp;
            var myvdom1111111 = Hn(class extends HTMLElement {
            ...
            document.body.appendChild(un(myvdom1111111, document.createElement("div")));
            document.body.appendChild(un(Hn((() => {
            ...
            const myele1 = Hn((_temp = _class = class extends HTMLElement {}, _defineProperty(_class, "defaultProps", {
                name: "aaaaaaaaaaHelloKitty",
                myAge: 0x71afd498cfffe
            }), _temp));
            console.log(myele1);
            document.body.appendChild(un(myele1, document.createElement("div")));
            document.body.appendChild(un(myele1, document.createElement("div")));
        })();
    })();
    {
        const vdom = Hn("div", [ [ Hn("html", null, "testhtml"), Hn("button", {
            onclick: [ console.log, () => {
                console.log("onclick");
            } ],
            "*text": "clicktest",
    ...
    (async () => {
        ...
        const Hellowordclass = Object.assign(() => Hn("div", [ "hello world" ], "\u6d4b\u8bd5\u4e0d\u4f7f\u7528createComponent"), {
            css: css,
            defaultProps: defaultProps
        });
        const vdom = Hn(Hellowordclass, null);
        let vdom1 = Hn(Hellowordclass);
        document.body.appendChild(un([ vdom, vdom1 ], document.createElement("div")));
    ...
    (() => {
        ...
        const vdom = [ Hn("hr", null), Hn("h1", {
            style: stylestate
        }, "input color ", colortext), Hn("input", {
            $value: colortext
        }), Hn("hr", null) ];
        console.log([ vdom, colortext, stylestate ]);
        Gn([ colortext, stylestate ], (a, b) => console.log([ a, {
            ...b
        } ]));
        document.body.appendChild(un(vdom, document.createElement("div")));
    })();
    ...
    console.log([ Hn, Hn ]);
    (() => {
        var mycom = Wn(Object.assign((props, children) => {
            const number = Mr(1);
            Gt(() => {
            ...
            }, [ number, Hn("br", null), "wwwwwwwwwwww", Hn("div", [ "createComponent" ]), children, Hn("div", Hn("", null, "props cccccc ", props.cccccc)) ]);
        }, {
            defaultProps: {
                cccccc: "bbbbbbb"
            },
        ...
        document.body.appendChild(un(Hn(myclasscomponent, [ Hn("form", {
            id: "newsletterForm",
    ...
    document.body.appendChild(sn(Hn(() => Hn("div", null, Hn("button", {
        $text: "component 1",
        onclick: () => {
            mystate.value = com1;
        }
