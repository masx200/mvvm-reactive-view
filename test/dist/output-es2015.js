(function() {
    ...
    !function() {
            ...
            Object.defineProperty(t, `on${e}`, function(t) {
                return {
                    ...
                    set(e) {
                        ...
                        for (;null != r; ) 3 === r.listenerType ? null !== o ? o.next = r.next : null !== r.next ? n.set(t, r.next) : n.delete(t) : o = r, 
                        r = r.next;
                        if (null !== e) {
                            const r = {
                                listener: e,
        ...
        function y() {
            if (!(this instanceof y)) {
                if (1 === arguments.length && Array.isArray(arguments[0])) return d(arguments[0]);
        ...
        y.prototype = {
            addEventListener(t, e, n) {
                ...
                const o = f(this), r = p(n), i = (r ? Boolean(n.capture) : Boolean(n)) ? 1 : 2, l = {
                    listener: e,
                    listenerType: i,
            ...
            removeEventListener(t, e, n) {
                if (null == e) return;
                const o = f(this), r = (p(n) ? Boolean(n.capture) : Boolean(n)) ? 1 : 2;
            ...
            dispatchEvent(t) {
                ...
                for (;null != r; ) {
                    ...
                    } catch (t) {} else 3 !== r.listenerType && "function" == typeof r.listener.handleEvent && r.listener.handleEvent(i);
                    if (c(i)) break;
                    r = r.next;
                }
            ...
            configurable: !0,
            writable: !0
        }), "undefined" != typeof window && void 0 !== window.EventTarget && Object.setPrototypeOf(y.prototype, window.EventTarget.prototype), 
        (() => {
            try {
                new EventTarget;
            } catch (t) {
    ...
    const jt = new u, Tt = new u, kt = new u;
    let Lt = [];
    let Nt = !1, Dt = new j, Mt = new j, Rt = new j;
    function _t(t) {
        if (!q(t)) throw L();
        if (!Nt) throw k();
        Dt.add(t);
    ...
    var Gt, Qt;
    const Xt = i.EventTarget, Yt = S("addonelistner"), te = S("removeonelistner"), ee = S("cancelsubscribe"), ne = S("debouncedispatch");
    function re(t) {
    ...
    class fe {
        constructor(t) {
            var e;
            this[S.toStringTag] = "ReactiveState", this[Gt] = new Xt, this[Qt] = new j, this.valueOf = () => this.value, 
            this.value = t, Ft(this, "value", {
                value: t,
                configurable: !0,
                writable: !0
            }), e = this, Nt && Rt.add(e);
            const n = xt(t => {
                const e = t ? y(t) : "value";
                this[oe].dispatchEvent(new h("value", {
                    detail: e
                }));
            });
            this[ne] = t => {
    ...
    function ye(t, e = {}, n = []) {
        ...
        return [ "onevent", "element", "type", "props", "children", "directives", "bindattr" ].forEach(t => {
            ...
            children: n,
            onevent: E.fromEntries(pe([ ...r.filter(([t]) => "@" == t[0]).map(([t, e]) => [ t.slice(1).toLowerCase().trim(), [ e ].flat(1 / 0) ]), ...r.filter(([t]) => t.startsWith("on")).map(([t, e]) => [ t.slice(2).toLowerCase().trim(), [ e ].flat(1 / 0) ]) ])),
            directives: E.fromEntries(o.filter(([t]) => "*" === t[0] || "_" === t[0] || "$" === t[0]).map(([t, e]) => [ t.slice(1).toLowerCase().trim(), e ]))
        }), Ft(s, S.toStringTag, {
            value: "VirtualElement"
        }), Vt(s), ve.add(s), E.freeze(c), s;
    }
    function ge(t, e, n) {
        return e in t ? E.defineProperty(t, e, {
            value: n,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    const Ee = [ "input", "textarea", "option", "select" ];
    var Oe = (t, e, n) => "value" === e && Ee.includes(t) && "button" !== n || "selected" === e && "option" === t || "checked" === e && "input" === t || "muted" === e && "video" === t;
    const Pe = /\B([A-Z])/g, Se = i.String, Ce = i.Reflect, {get: xe, set: je, ownKeys: Te} = Ce;
    function ke(t) {
        return "object" == typeof t && null !== t;
    }
    function Le(t) {
    ...
    const De = t => "input" === Re(t) && ("checkbox" === xe(t, "type") || "radio" === xe(t, "type"));
    function Me(t) {
        !function(t) {
        ...
        const n = new P(e, {
            ownKeys() {
                const e = function(t) {
                    const e = Re(t);
                    return "textarea" === e || "select" === e || "input" === e && "text" === xe(t, "type");
                }(t), n = function(t) {
                    return t.getAttributeNames();
                }(t);
                return g.from(new j([ ...n, De(t) ? "checked" : void 0, e ? "value" : void 0 ].flat(1 / 0).filter(t => !!t)));
            },
            get(e, n) {
                if (Oe(Re(t), Se(n), xe(t, "type"))) return xe(t, Se(n));
                {
            ...
            set(e, n, r) {
                ...
                if (Oe(Re(t), Se(n), xe(t, "type"))) return je(t, Se(n), r);
                if ("style" === n) {
                    const e = Le(r) ? r : ke(r) ? (i = r, i = N.parse(N.stringify(i)), E.entries(i).map(([t, e]) => {
                        return [ (n = t, n.replace(Pe, "-$1").toLowerCase()).trim(), e ];
                        var n;
                    }).map(([t, e]) => t + ":" + e).join(";")) : Se(r);
                    return je(xe(t, "style"), "cssText", e.trim()), !0;
                }
                if ("class" === n && ke(r)) {
                    const e = (o = r, g.isArray(o) ? r.join(" ") : Ne(r) ? [ ...r ].join(" ") : Se(r));
                    return _e(t, Se(n), e), !0;
                }
                return !1 === r || null == r ? (Ae(t, Se(n)), !0) : Ne(r) ? (_e(t, Se(n), N.stringify([ ...r ])), 
                !0) : (!0 === r && (r = ""), _e(t, Se(n), ke(r) ? N.stringify(r) : Se(r)), !0);
                var o, i;
            },
            deleteProperty: (e, n) => (Ae(t, Se(n)), !0),
            has: (t, e) => Te(n).includes(e),
            defineProperty: () => !1,
            getOwnPropertyDescriptor(t, e) {
                ...
                return void 0 !== o ? function(t) {
                    for (var e = 1; e < arguments.length; e++) {
                        var n = null != arguments[e] ? arguments[e] : {};
                        e % 2 ? be(E(n), !0).forEach((function(e) {
                            ge(t, e, n[e]);
                        })) : E.getOwnPropertyDescriptors ? E.defineProperties(t, E.getOwnPropertyDescriptors(n)) : be(E(n)).forEach((function(e) {
    ...
    function $e(t) {
        if (U(t)) return !0;
        if (F(t)) return !0;
        return I(t) ? t.every(t => $e(t)) : me(t) ? $e(t.children) : !!re(t);
    }
    function We(t) {
    ...
    const He = g(26).fill(void 0).map((t, e) => 97 + e).map(t => y.fromCharCode(t)), Fe = g(16).fill(void 0).map((t, e) => e).map(t => t.toString(16)), ze = [ ...new j([ ...Fe, ...He ]) ];
    function Be(t = 1) {
        return g(t).fill(void 0).map(() => Zt(He, T.floor(T.random() * He.length))).join("") + "-" + g(t).fill(void 0).map(() => Zt(ze, T.floor(T.random() * ze.length))).join("");
    }
    if (!B(i.customElements)) throw new L;
    i.CustomElementRegistry = Zt(Ut(i.customElements), "constructor");
    const Ue = S.for("elementset"), qe = S.for("elementmap"), {CustomElementRegistry: Ie} = i, Ve = i.customElements;
    qt(Ve, Ue) || O.set(Ve, Ue, new j), qt(Ve, qe) || O.set(Ve, qe, {});
    function Ze(t, e, n = 1) {
        if (!We(t)) throw L();
        if (Zt(Ve, Ue).has(t)) return function(t, e) {
            const n = E.entries(t).find(t => t[1] === e);
            return n ? n[0] : void 0;
        }(Zt(Ve, qe), t);
        {
            const r = Be(n);
            return Ve.get(r) ? Ze(t, e, n + 1) : (e ? Ve.define(r, t, {
                extends: e
            }) : Ve.define(r, t), r);
        }
    }
    function Je(t, e, n) {
        let r = t;
        if (q(r) && (r = Qn(r)), We(t = r)) return ((t, e) => {
            Ze(t, e);
        })(t), Ht(t, [ e, n ]);
        throw L();
    }
    Ve.define = function(t, e, n) {
        if (!We(e)) throw L();
        Zt(Ve, Ue).has(e) || (qt(Ve[qe], t) ? Ze(e, n ? n.extends : void 0) : (Ie.prototype.define.call(Ve, t, e, n), 
        Ve[Ue].add(e), Ve[qe][t] = e));
    }, Jt(Ve, S.iterator, () => {
        const t = E.entries(Ve[qe]);
        return t[S.iterator].call(t);
    });
    const Ge = S("component");
    function Qe(t, e) {
        t.textContent = e;
    }
    function Xe(t, e) {
    ...
    function fn(t, e, n = !0) {
        return n && Qe(e, ""), le(t).flat(1 / 0).forEach(t => Ye(e, t)), e;
    }
    function ln(t) {
    ...
    function hn(t, e) {
        ...
        const r = le(t);
        if ($e(t)) fn(En(r), e); else {
            if (!(ln(t) || (o = t, I(o) && o.length && o.every(t => ln(t))))) throw L();
            fn(r, e);
        }
        var o;
        return e;
    ...
    const mn = S("eventlisteners");
    function yn(t, e, n) {
        !function(t, e, n) {
            const r = t;
            n.forEach(n => {
                if (!q(n)) throw L();
                qt(r, mn) || Jt(r, mn, []), Zt(t, mn).push([ e, n ]), sn(t, e, n);
            });
        }(t, e, le(n));
    }
    const gn = S("bindstate");
    function bn(t) {
        throw L();
    }
    function En(t, e) {
        if (I(t)) return t.map(t => En(t)).flat(1 / 0);
        if (F(t) || U(t)) {
            return nn(t);
        }
        if (re(t)) {
            ...
            const r = n;
            return Jt(r, gn, new j), Zt(r, gn).add(e), n;
        }
        if (me(t)) {
            let {type: o} = t;
            q(o) && (o = Qn(o));
            let i = void 0;
            if ("string" == typeof o) {
                if ("script" === o) return tn();
                if ("svg" === o) i = en(rn, "svg"); else if ("math" === o) i = en("http://www.w3.org/1998/Math/MathML", "math"); else {
                    if ("" === o || "html" === o) {
                        const e = tn();
                        return fn(En(t.children), e), e;
                    }
                    i = e ? en(e, o) : function(t) {
            ...
            return o && (q(o) || U(o)) && (q(r = o) && Zt(r, Ge) === Ge || i && fn(t.children.map(t => "svg" === o && me(t) ? En(t, rn) : "math" === o && me(t) ? En(t, "http://www.w3.org/1998/Math/MathML") : e && me(t) ? En(t, e) : En(t)), i)), 
            i && function(t, e) {
                e.element.push(t), ((t, e) => {
                    E.entries(e.directives).forEach(([n, r]) => {
                        if (!q(wn[n])) throw new k;
                        wn[n](r, t, e);
                    });
                    const n = Me(t);
                    ...
                    qt(t, gn) || Jt(t, gn, new j), Zt(t, gn).add(e);
                });
            }(i, t), i;
        }
        var r;
    ...
    function Sn(t, e, n) {
        ...
        Zt(On, r) || Jt(On, t, new j), e ? Zt(On, r).add(function(t) {
            const e = Pn.get(t);
            if (e) return e;
            {
    ...
    function Cn(t, e) {
        return t.map(t => {
            ...
            return function(t) {
                ...
                const n = Cn([ ...t.cssRules ], e), r = t.conditionText;
                return {
                    cssText: t.cssText.slice(0, 7) + r + "{" + Ke(n) + "}",
                    conditionText: r,
                    cssRules: n,
            ...
            }(t) ? void Sn(e, void 0, t.href) : t;
        }).filter(C);
    }
    function xn(t) {
        const e = En(Xn("style", [ t ]));
        return Ye(b.implementation.createHTMLDocument("").documentElement, e), g.from(Zt(Zt(e, "sheet"), "cssRules"));
    }
    const jn = new D;
    function Tn(t, e) {
        Sn(e, function(t, e) {
            ...
            if (n) return n;
            {
                const n = Ke(Cn(xn(t), e).filter(C));
                return jn.set(t, n), n;
            }
        }(t, e));
    }
    function kn(t, e) {
        return x.all([ ...Zt(On, t) ].map(t => {
            return an(`link[rel="stylesheet"][href="${t}"]`).length ? x.resolve() : (n = En(Xn("link", {
                href: t,
                rel: "stylesheet"
            })), r = e, new x(t => {
                const e = () => {
    ...
    function Dn(t) {
        if (I(t)) t.forEach(t => {
            ...
            if (function(t) {
                qt(t, mn) && Zt(t, mn).forEach(([e, n]) => {
                    sn(t, e, n);
                });
            }(t), qt(t, gn) && Zt(t, gn).forEach(t => {
                de(t), t[se]();
            }), qt(t, Bn) && Zt(t, Bn).forEach(t => {
                de(t);
            }), qt(t, zn)) {
                Zt(t, zn).forEach(([t, e]) => {
                    const n = jt.get(e);
    ...
    var _n;
    const An = S("attributeChanged"), $n = S("firstinstalled");
    function Wn(t) {
    ...
    class Hn extends HTMLElement {
        constructor() {
            super(), this[_n] = !1;
            const t = Zt(this.constructor, "defaultProps"), e = Me(this);
    ...
    _n = Rn;
    const Fn = S("waittranformcss"), zn = S("innerwatchrecord"), Bn = S("innerstate"), Un = S("attributes"), qn = S("innerelement"), In = S("innervdom"), Vn = S("mounted"), Zn = S("unmounted");
    function Jn(t) {
        var e, n, r;
        if (q(t)) {
            const o = Tt.get(t);
            ...
            class c extends Hn {
                constructor(n = {}, o = []) {
                    ...
                    if (i) {
                        ...
                        Zt(On, t) || (Jt(On, t, new j), this[Fn] = () => Nn(() => {
                            Tn(i, t);
                        }));
                    }
                    const s = Me(this);
                    ...
                    this[Un] = u;
                    const a = Ln(E.fromEntries(E.entries(u).map(([t, e]) => [ t, Ln(e) ])));
                    let f;
                    try {
                    ...
                    {
                        const t = le(f);
                        this[In] = t.flat(1 / 0).filter(C), this[Vn] = [ ...Dt ], this[Zn] = [ ...Mt ], 
                        this[Bn] = [ ...Rt ], this[zn] = [ ...Lt ], $t();
                    }
                }
                [(e = Un, n = Ge, r = Rn, $n)]() {
                    const t = () => (Qe(this, ""), kn(r, b.head)), e = () => {
                        fn(this[qn], this, !1), this[Fn] = void 0;
                    };
                    if (!this[qn]) {
                        const t = this[In];
                        t && (this[qn] = En(t).flat(1 / 0), this[In] = []);
                    }
                    const n = Zt(this.constructor, "css"), r = this.tagName.toLowerCase();
                    if (n) {
                        const n = this[Fn];
                        n ? n().then(t).then(e) : x.resolve(t).then(e);
                    } else fn(this[qn], this);
                }
                connectedCallback() {
                    Nn(() => {
                        Wn(this), this[Vn].forEach(t => {
                            Nn(t);
                        });
                    });
                }
            ...
            return c[n] = Ge, c.css = U(s) && s ? s : void 0, c.defaultProps = B(i) ? N.parse(N.stringify(i)) : void 0, 
            Tt.set(t, c), c;
        }
        throw L();
    }
    ...
    function Xn(t, e, ...n) {
        return q(t) && (t = Qn(t)), I(e) ? Kt(Yn, void 0, [ t, void 0, [ ...e, ...n ].flat(1 / 0) ]) : Kt(Yn, void 0, [ t, e, ...n ]);
    }
    function Yn(t, e = {}, ...n) {
        let r = U(t) || q(t) ? t : "";
        const o = K(e) ? e : {}, i = n.flat(1 / 0).map(t => 0 === t ? "0" : t).filter(t => !!t);
        return U(r) && (r = r.trim().toLowerCase()), "" === r ? i : Kt(ye, void 0, [ r, o, i ]);
    }
    const tr = S("truevdom"), er = S("falsevdom"), nr = S("trueele"), rr = S("falseele"), or = S("handletrue"), ir = S("handlefalse"), sr = S("currentelement");
    function cr(t, e, n) {
        var r, o, i, s, c;
        if (!re(t) && !z(t)) throw L();
        [ e, n ].forEach(t => {
            if (!(H(t) || me(t) || U(t))) throw new L;
        });
        const u = e, a = n;
        class f extends Hn {
            constructor() {
            ...
            [(r = sr, o = Ge, i = Rn, s = tr, c = er, ir)]() {
                this[rr] || (this[rr] = En(this[er]), this[er] = []);
                const t = this[rr][0] || this;
                on(t, this[sr]), this[sr] = t;
            }
            [or]() {
                this[nr] || (this[nr] = En(this[tr]), this[tr] = []);
    ...
    const fr = j.prototype, lr = D.prototype;
    function hr(t) {
        return t instanceof D;
    }
    function dr(t) {
    ...
    const vr = i.Reflect, {ownKeys: wr, deleteProperty: mr, apply: yr, construct: gr, defineProperty: br, get: Er, getOwnPropertyDescriptor: Or, getPrototypeOf: Pr, has: Sr, set: Cr, setPrototypeOf: xr} = vr;
    function jr(t) {
        return "object" == typeof t && null !== t;
    }
    function Tr(t) {
    ...
    function kr(t, e, n = [], r = t) {
        ...
        if (Tr(t) || jr(t)) {
            let o;
            return dr(t) ? (o = new j([ ...t ]), Cr(o, "add", i => (fr.add.call(t, i), e(r, n, void 0, void 0), 
            fr.add.call(o, i))), Cr(o, "delete", i => (fr.delete.call(t, i), e(r, n, void 0, void 0), 
            fr.delete.call(o, i))), Cr(o, "clear", () => (fr.clear.call(t), e(r, n, void 0, void 0), 
            fr.clear.call(o)))) : hr(t) ? (o = new D([ ...t ]), Cr(o, "clear", () => (lr.clear.call(t), 
            e(r, n, void 0, void 0), lr.clear.call(o))), Cr(o, "set", (i, s) => (lr.set.call(t, i, s), 
            e(r, n, void 0, void 0), lr.set.call(o, i, s))), Cr(o, "delete", i => (lr.delete.call(t, i), 
            e(r, n, void 0, void 0), lr.delete.call(o, i)))) : o = pr(t) ? [] : Tr(t) ? () => {} : {}, 
            dr(t) || hr(t) || xr(o, null), new P(o, {
                defineProperty: (o, i, s) => (e(r, [ ...n, y(i) ], Sr(s, "value") ? s.value : Tr(s.get) ? s.get() : void 0, Er(t, i)), 
                br(t, i, s)),
                deleteProperty: (o, i) => (e(r, [ ...n, y(i) ], void 0, Er(t, i)), mr(t, i)),
                ownKeys: () => wr(t),
                has: (e, n) => Sr(t, n),
                getPrototypeOf: () => Pr(t),
                setPrototypeOf: (e, n) => xr(t, n),
                construct(e, n) {
                ...
                getOwnPropertyDescriptor(e, n) {
                    var r = Or(t, n);
                    return pr(t) && "length" === n ? r : r ? (r.configurable = !0, r) : void 0;
                },
                set: (o, i, s) => (Tr(e) && e(r, [ ...n, y(i) ], s, Er(t, i)), Cr(t, i, s)),
                get(r, i) {
                    var s = Er(t, i);
                    return Tr(s) && (dr(t) || hr(t)) ? Er(o, i).bind(o) : Tr(s) || jr(s) ? kr(s, e, [ ...n, y(i) ], t) : s;
                }
            });
        }
        return t;
    ...
    function Dr(t) {
        return function t(e) {
            if ($(e) || q(e)) return ur(new P(new fe(e), {
                defineProperty: () => !1,
                deleteProperty: () => !1,
                set(t, n, r) {
                    if ("value" === n && ($(r) && $(e) || q(r) && q(e))) return t[n] !== r && (Jt(t, n, r), 
                    t[se]()), !0;
                    throw L();
                },
                setPrototypeOf: () => !1
            }));
            if (re(e)) return t(e.valueOf());
    ...
    const Mr = S("listvalueattr"), Rr = S("listinnervdom"), _r = S("listinnerelement"), Ar = S("cached_realele");
    function $r(t, e) {
        var n, r, o, i;
        ...
        class c extends Hn {
            constructor() {
                super(...arguments), this[n] = new D, this[r] = Dr([]), this[i] = !1;
            }
            [(n = Ar, r = Mr, o = Ge, i = Rn, An)](t) {
                if (this[Rn] && "value" === t) {
                    const t = Me(this).value;
                    if (!I(t)) throw new L;
                    Jt(this[Mr], "value", t);
                    const e = cn(this), n = t.length, r = e.length;
                    if (n > r) {
                        g(n).fill(void 0).map((t, e) => e).slice(r).map(t => {
                            const e = Zt(this[Ar], t);
                            if (e) return e;
                            {
                                const e = En(function(t, e) {
                                    return s(ar(e[Mr], e => e[t]), t);
                                }(t, this));
                                return Jt(this[Ar], t, e), e;
                            }
                        }).forEach(t => Ye(this, t));
                    } else n < r && cn(this).slice(n).forEach(t => function(t) {
                        t.remove();
                    }(t));
                }
            }
            ...
            [$n]() {
                const t = Me(this).value;
                if (!I(t)) throw new L;
                Jt(this[Mr], "value", t), this[Rr] = t.map((t, e) => s(ar(this[Mr], t => t[e]), e)), 
                this[_r] = En(this[Rr]), E.entries(this[_r]).forEach(([t, e]) => {
                    Jt(this[Ar], A(t), e);
                }), fn(this[_r], this), this[_r] = [], this[Rr] = [];
            }
            connectedCallback() {
                Wn(this);
            }
    ...
    const Wr = S("cancel_watch"), Kr = S("cached_class_element"), Hr = S("switch_mount");
    function Fr(t) {
        var e, n, r;
        if (!re(t)) throw new L;
        class o extends Hn {
    ...
    var qr = "function" == typeof D, Ir = qr ? new D : {};
    function Gr(t, e, n, r, o, i) {
        if (!re(o)) throw L();
        if (!t.includes(i.type)) throw L();
        Jt(i.bindattr, e, o), r.forEach(t => {
            const e = le(i.onevent[t]);
            Jt(i.onevent, t, le([ ...e, t => o.value = Zt(t.target, n) ]).filter(C));
        });
    }
    vn({
        value(t, e, n) {
            Gr([ "input", "textarea", "select" ], "value", "value", [ "change", "input" ], t, n);
        },
        checked(t, e, n) {
            ...
            Jt(n.onevent, "click", le([ ...r, t => {
                ...
                n && an(`input[name=${n}]`).filter(t => t !== e).forEach(t => {
    ...
    const mycomapp = Gn(() => {
        ...
        return Xn("div", null, Xn("h3", null, " \u9f20\u6807\u4f4d\u7f6e"), Xn("h2", null, "x:", x), Xn("h1", null, "y:", y), Xn("p", null, "x+100 \u662f", plus), Xn("p", null, "x*y \u662f", multi));
    });
    mycomapp.css = `\n*{font-size:80px !important;}\np{color:blue !important;}\n`;
    var vdom = Xn(mycomapp);
    document.body.appendChild(hn(vdom, document.createElement("div")));
    const refarray = [];
    const liststate = Dr(Array(10).fill(undefined).map((v, i) => i));
    he(liststate, a => console.dir([ liststate, a ]));
    const testlistvdom = Xn("div", null, Xn("button", {
        _text: "push",
        onclick: () => {
    ...
    }), $r(liststate, (value, index) => Xn("div", {
        _ref: ele => {
    ...
    const vdom$1 = [ cr(weathercondition, testlistvdom), Xn("", null, Xn("button", {
        onclick: () => {
            weathercondition.value = !weathercondition.value;
        }
    }, "condition toggle")) ];
    document.body.appendChild(hn(vdom$1, document.createElement("div")));
    ...
    const mycomapp$1 = Gn(() => {
        ...
        const vdom = [ Xn("h1", {
            ...
            style: "\n      width: 100%;\n      height: 200px;\n  "
        }, Xn("title", null, "logo-on-dark-bg"), Xn("rect", {
            Color: "#FFF",
            x: "0",
            y: "0",
            width: "3046.7",
        ...
        }))), Xn("div", null, Xn("div", null, Xn("noscript", null, "You need to enable JavaScript to run this app."), Xn("div", {
            id: "root"
        }, Xn("div", null, Xn("div", {
            ...
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/picalc"
        }, "\u5706\u5468\u7387\u8ba1\u7b97\u591a\u7ebf\u7a0b")), Xn("li", null, Xn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/react-huami"
        }, "\u82b1\u5bc6\u7f51\u9875\u7248")), Xn("li", null, Xn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/decoder"
        }, "JSfuck-and-hieroglyphy-Decoder")), Xn("li", null, Xn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/jsfuck"
        }, "JSfuck-ENCODER")), Xn("li", null, Xn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/hieroglyphy"
        }, "hieroglyphy-ENCODER")), Xn("li", null, Xn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
        ...
        }, "\u52a8\u6001\u5f02\u6b65\u52a0\u8f7d-commonjs\u548cumd\u548camd\u6a21\u5757\u5e93")), Xn("li", {
            class: "nav-item"
        }, Xn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
            href: "#/react-simple-global-state-store-hook"
        }, "\u9002\u7528\u4e8eReact\u7684\u6781\u7b80\u5168\u5c40\u72b6\u6001\u7ba1\u7406\u5e93")), Xn("li", {
            class: "nav-item"
        }, Xn("a", {
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined",
        ...
        }, "\u9002\u7528\u4e8eVue\u7684\u6781\u7b80\u5168\u5c40\u72b6\u6001\u7ba1\u7406\u5e93")), Xn("li", null, Xn("a", {
            href: "./my-vue-router-project/index.html",
            class: "nav-link mui-btn mui-btn-primary mui-btn-outlined"
        }, "\u57fa\u4e8evue\u7684\u4e3b\u9875")), Xn("li", null, Xn("a", {
        ...
        }, Xn("h1", null, "\u82b1\u5bc6 \u4e0d\u4e00\u6837\u7684\u5bc6\u7801\u7ba1\u7406\u5de5\u5177"), Xn("div", {
            id: "rong1",
            class: "container",
            style: "text-align: center;"
        }, Xn("div", {
            id: "rong2"
        }, Xn("h2", null, Xn("span", null, "1"), "\u8f93\u5165"), Xn("div", {
            id: "input"
        }, Xn("p", null), Xn("h3", null, "\u8bb0\u5fc6\u5bc6\u7801"), Xn("p", null), Xn("p", null, Xn("input", {
            "*ref": inputref,
            ...
            value: ""
        })), Xn("p", null), Xn("span", null, "+"), Xn("h3", null, "\u533a\u5206\u4ee3\u53f7"), Xn("p", null), Xn("p", null, Xn("input", {
            "*ref": inputref2,
            "*value": inputpassword,
            "@input": e => console.log(e),
            id: "key",
            ...
            class: "col-lg-12 col-md-12 col-sm-12 col-xs-12 form-control",
            value: ""
        }))), Xn("br", null), Xn("p", null), Xn("h2", null, Xn("span", null, "2"), "\u83b7\u53d6"), Xn("p", null), Xn("div", {
            id: "get"
        }, Xn("p", {
            id: "tuijian"
        }), Xn("p", null), Xn("h3", null, "\u6700\u7ec8\u5bc6\u7801"), Xn("p", null), Xn("span", {
            id: "myhezi"
        }, Xn("p", null, Xn("input", {
            ...
            value: ""
        })), Xn("br", null), Xn("p", null, Xn("button", {
            id: "copycode16",
            "data-clipboard-target": "#code16",
            class: "btn btn-lg btn copycode16d btn-info",
            style: "width: 100%;"
        }, "\u70b9\u51fb\u590d\u5236"))), Xn("p", null, Xn("span", {
            id: "copyOK",
            style: "display: none;"
        }, "\u221a\u590d\u5236\u6210\u529f")), Xn("p", null)))))))), Xn("script", {
    ...
    hn(vdom$2, document.getElementById("root"));
    console.log([ Xn, Xn ]);
    const vdom$3 = Xn("select", {
        ...
        value: "0"
    }, "- Select version -"), Xn("option", {
        value: "94b92331-e2f4-40c6-90ee-80e203a4de3a"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [arm64]"), Xn("option", {
        value: "7268dbc9-dfe0-4947-af82-67f384e95cb6"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x64]"), Xn("option", {
        value: "08f0d32e-c68a-46a8-b301-57e86b4e96e0"
    }, "Windows 10 Insider Preview 18999.1 (vb_release) [x86]"), Xn("option", {
        value: "9fa87c7f-75fa-4e5e-9ca3-1e19cb2c743f"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x64]"), Xn("option", {
        value: "5173796c-11ac-47d7-9ed7-dbad6d5c9486"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [x86]"), Xn("option", {
        value: "4adf5f24-213a-472c-ae94-70f3cb81bade"
    }, "Windows 10 Insider Preview 18995.1 (vb_release) [arm64]"), Xn("option", {
        value: "9287fe5e-2cb3-4064-820f-3e336a3ddff4"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [arm64]"), Xn("option", {
        value: "5e420f0d-b3a5-424c-9b55-5c2cf939af14"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [x86]"), Xn("option", {
        value: "13e2104c-c98c-43b2-b232-9b2a4b5af2ac"
    }, "Windows 10 Insider Preview 18990.1 (vb_release) [x64]"));
    const element = document.body.appendChild(hn(vdom$3, document.createElement("div")));
    ...
    const mycomappclass = Gn(() => {
        ...
        const vdom = Xn("div", null, Xn("h3", null, " \u70b9\u51fb\u6570\u5b57"), Xn("h2", null, "number:", store.number), Xn("button", {
    ...
    document.body.appendChild(hn(vdom$4, document.createElement("div")));
    setTimeout(() => {
        vdom$4.forEach(vdom => {
    ...
    var vdom$5 = Xn("", null, Xn("input", {
        ...
        type: "checkbox",
        _checked: notcheck
    }), Xn("", null, Xn("ul", null, list.map((a, index) => Xn("li", {
        $ref: ele => {
            lirefs[index] = ele;
        ...
        class: "title"
    }, "\u4f60\u7684\u4ed3\u5e93 masx200/mvvm-reactive-view \u5df2\u7ecf\u4ece https://github.com/masx200/mvvm-reactive-view.git \u540c\u6b65\u6210\u529f"), Xn("div", {
        class: "meta"
    }, Xn("time", {
        class: "timeago"
    }, "2\u5c0f\u65f6\u524d"), " \xb7", " ", Xn("span", {
        class: "namespace"
    }, "masx200/mvvm-reactive-view")))), Xn("div", {
    ...
    document.body.appendChild(hn(vdom$5, document.createElement("div")));
    console.log([ Xn, Xn ]);
    (() => {
        var mystate = Dr(true);
        console.log("mystatetest", mystate);
        var vdom = cr(mystate, "testtrue", Xn("div", undefined, "testfalese"));
        var vdom2 = cr(mystate, undefined, Xn("div", undefined, "testwwwwwwwwwfalese"));
        var vdom3 = cr(mystate, Xn("div", undefined, "testwwwwwwwtrueeeeeeeeee"), undefined);
        console.log([ vdom, vdom2, vdom3 ]);
        document.body.appendChild(hn([ vdom, vdom2, vdom3 ], document.createElement("div")));
    ...
    (() => {
        ...
        console.log(vdom);
        hn(vdom, document.getElementById("app"));
    })();
    (() => {
        const vdom2 = [ Xn("div", {
        ...
        console.log(vdom2);
        document.body.appendChild(hn(vdom2, document.createElement("div")));
        const state1 = Dr("<a>\u7ed1\u5b9atextcontent</a>");
        const state2 = Dr("<a>\u7ed1\u5b9ainnerhtml</a>");
        const vdom3 = [ Xn("textarea", {
            value: state1,
            "@input": [ e => {
        ...
        console.log(vdom3);
        document.body.appendChild(hn(vdom3, document.createElement("div")));
        const state3 = Dr("<a>\u7ed1\u5b9ainnerhtml</a>");
        const vdom4 = Xn("", null, Xn("div", {
            _text: state3
        }), Xn("div", {
            _html: state3
        }), Xn("script", null, " "));
        ...
        console.log(state3);
        console.log(vdom4);
        document.body.appendChild(hn(vdom4, document.createElement("div")));
        const objstate = Dr({
            a: "w",
            6: "xxxxxxx",
            tttttttt: "true"
        ...
        }, objstatearray), objstate, Xn("div", {
            style: stylestate,
            class: classsetstate
        }) ];
        document.body.appendChild(hn(vdomobj, document.createElement("div")));
        console.log(vdomobj);
    ...
    (() => {
        var vdom = Xn("math", null, Xn("mrow", null, Xn("mrow", null, Xn("msup", null, Xn("mi", null, "a"), Xn("mn", null, "2")), Xn("mo", null, "+"), Xn("msup", null, Xn("mi", null, "b"), Xn("mn", null, "2"))), Xn("mo", null, "="), Xn("msup", null, Xn("mi", null, "c"), Xn("mn", null, "2"))));
        document.body.appendChild(hn(vdom, document.createElement("div")));
        console.log(vdom);
    })();
    ...
    document.body.appendChild(hn([ Xn(Bqqqqqqqqq), Xn(Aqqqqqqqqq) ], document.createElement("div")));
    console.log([ Xn, Xn ]);
    (() => {
        (() => {
            var _class, _temp;
            var myvdom1111111 = Xn(class extends HTMLElement {
            ...
            document.body.appendChild(hn(myvdom1111111, document.createElement("div")));
            document.body.appendChild(hn(Xn((() => {
            ...
            const myele1 = Xn((_temp = _class = class extends HTMLElement {}, _defineProperty(_class, "defaultProps", {
                name: "aaaaaaaaaaHelloKitty",
                myAge: 0x71afd498cfffe
            }), _temp));
            console.log(myele1);
            document.body.appendChild(hn(myele1, document.createElement("div")));
            document.body.appendChild(hn(myele1, document.createElement("div")));
        })();
    })();
    {
        const vdom = Xn("div", [ [ Xn("html", null, "testhtml"), Xn("button", {
            onclick: [ console.log, () => {
                console.log("onclick");
            } ],
            "*text": "clicktest",
    ...
    (async () => {
        ...
        const Hellowordclass = Object.assign(() => Xn("div", [ "hello world" ], "\u6d4b\u8bd5\u4e0d\u4f7f\u7528createComponent"), {
            css: css,
            defaultProps: defaultProps
        });
        const vdom = Xn(Hellowordclass, null);
        let vdom1 = Xn(Hellowordclass);
        document.body.appendChild(hn([ vdom, vdom1 ], document.createElement("div")));
    ...
    (() => {
        ...
        const vdom = [ Xn("hr", null), Xn("h1", {
            style: stylestate
        }, "input color ", colortext), Xn("input", {
            _value: colortext
        }), Xn("hr", null) ];
    ...
    console.log([ Xn, Xn ]);
    (() => {
        var mycom = Gn(Object.assign((props, children) => {
            const number = Dr(1);
            _t(() => {
            ...
            }, [ number, Xn("br", null), "wwwwwwwwwwww", Xn("div", [ "createComponent" ]), children, Xn("div", Xn("", null, "props cccccc ", props.cccccc)) ]);
        }, {
            defaultProps: {
                cccccc: "bbbbbbb"
            },
        ...
        document.body.appendChild(hn(Xn(myclasscomponent, [ Xn("form", {
            id: "newsletterForm",
    ...
    setTimeout(() => {
        Object.values(Object.fromEntries(customElements)).map(c => En(Xn(c))).forEach(e => document.body.appendChild(e));
    }, 8e3);
    setTimeout(() => {
    ...
    document.body.appendChild(En(Xn(() => Xn("div", null, Xn("button", {
        $text: "component 1",
        onclick: () => {
            mystate.value = com1;
        }
