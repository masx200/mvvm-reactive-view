import { computed, createRef, createState, h, MountElement, watch } from "./mvvm-view";
console.log(h);
const lirefs = [];
...
var vdom = (<>
    ...
    <>
        ...
        lirefs.length = list.length;
                ...
                <header class="common-header fixed noborder floating" id="git-header-nav" $ref={temp$ref}>
                    <div class="ui container">
                        <div class="ui menu header-menu">
                                    ...
                                    <div class="gitee-nav__sidebar-top">
                                        <div class="gitee-nav__avatar-box">
                                            <a href="/masx200" onclick={(e) => e.preventDefault()}>
                                                <img alt="1081296_masx200" class="ui avatar image masx200-avatar" src="https://avatar.gitee.com/uploads/96/1081296_masx200.png?1566294318"/>
                                            </a>
                                        </div>
                            ...
                            <div class="item gitosc-logo">
                                <a href="/">
                                    <img class="ui inline image" height="28" src="https://gitee.com//logo.svg?20171024" width="95"/>
                            ...
                            <a href="https://blog.gitee.com/" class="item" id="gitee-blog" target="_blank" title="博客">
                                博客
                            </a>
                            <div class="dropdown item ui" id="my-gitee-dropdown" tabindex="0">
                                ...
                                <div class="menu transition hidden" tabindex="-1">
                                    <div class="header user-projects">
                                        <a href="/masx200/projects" class="pull-right" target="_blank">
                                            全部
                                        </a>
                                        仓库
                                        <span class="count">(11)</span>
                                    </div>
                                    <a target="_blank" href="/masx200/mvvm-reactive-view" title="masx200/mvvm-reactive-view" class="item">
                                        masx200/mvvm-reactive-view
                                    </a>
                                    <a target="_blank" href="/masx200/webpack-react-vue-spa-awesome-config" title="masx200/webpack-react-vue-spa-awesome-config" class="item">
                                        masx200/webpack-react-vue-spa-awesome-config
                                    </a>
                                    <a target="_blank" href="/masx200/custom-elements-random-define" title="masx200/custom-elements-random-define" class="item">
                                        masx200/custom-elements-random-define
                                    </a>
                                    <a target="_blank" href="/masx200/importcjsamdumd" title="masx200/importcjsamdumd" class="item">
                                        masx200/importcjsamdumd
                                    </a>
                                    <a target="_blank" href="/masx200/dom-element-attribute-agent-proxy" title="masx200/dom-element-attribute-agent-proxy" class="item">
                            ...
                            <div class="center responsive-logo">
                                <a href="/">
                                    <img class="ui inline image" height="24" src="https://gitee.com//logo.svg?20171024" width="85"/>
                            ...
                            <div class="right menu userbar" id="git-nav-user-bar">
                                <div class="item git-nav-search-item">
                                    <form accept-charset="UTF-8" action="/search" autocomplete="on" data-text-filter="搜索格式不正确" data-text-require="搜索关键字不能少于1个" id="navbar-search-form" method="get">
                                ...
                                <div class="item ui dropdown empty" data-count-path="/notifications/unread_count" data-enable="" data-mark-notice-path="/notifications/mark" id="notice-dropdown" tabindex="0">
                                    ...
                                    <div class="notice-dropdown-panel menu transition hidden" tabindex="-1" style="left: -165px;">
                                        ...
                                        <div class="item notice-dropdown-panel-container">
                                            ...
                                            <div class="notice-list" style="min-height: auto;">
                                                <a class="noti" href="/masx200/mvvm-reactive-view" target="_blank" data-type="project" data-id="50555275">
                                                    <div class="title">
                                                        你的仓库
                                                        masx200/mvvm-reactive-view
                                                        已经从
                                        ...
                                        <div class="notice-dropdown-panel-footer">
                                            <div class="action">
                                                ...
                                                <div class="side right">
                                                    <a href="/notifications/infos" class="load-all" target="_blank">
                                                        查看全部
                                                    </a>
                                                </div>
                                            </div>
                                ...
                                <div class="ui dropdown link item" id="git-nav-create" tabindex="0">
                                    ...
                                    <div class="right menu" tabindex="-1">
                                        ...
                                        <a href="/projects/oauth_github" class="item">
                                            <i class="github icon"></i>从 GitHub
                                            导入仓库
                                        </a>
                                    </div>
                                </div>
                                <div class="ui dropdown item" id="git-nav-user" tabindex="0">
                                    ...
                                    <div class="right menu" tabindex="-1">
                                        ...
                                        <a href="https://gitee.com/help" class="item" target="_blank">
                                            <div class="mayun-icon my-ic-help my-ic-help-dims"></div>
                                            帮助
                                        </a>
                                        <div class="divider"></div>
                                        <a href="/logout" class="item destroy-user-session" data-method="delete" rel="nofollow">
...
//# sourceMappingURL=index-x.jsx.map