...
console.log(h);
const vdom = (<select onchange={(e) => console.log(e)} style={{ textAlign: "center", fontSize: "30px", color: "#65a4f0" }} value="94b92331-e2f4-40c6-90ee-80e203a4de3a" name="version_id" id="version_id" class="StyleSelectBox">
...
//# sourceMappingURL=index-select.jsx.map